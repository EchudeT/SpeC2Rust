# Interface Facts: main_root_quotearg_style_14
...
## Functions
### `quotearg_style`
- Definition location: [quotearg.c:964-968]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_style (enum quoting_style s, char const *arg);`
- Approximate function body length: 5 lines
### `quotearg_style_mem`
- Definition location: [quotearg.c:970-974]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_style_mem (enum quoting_style s, char const *arg, size_t argsize);`
- Approximate function body length: 5 lines

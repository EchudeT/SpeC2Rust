# Interface Facts: main_root_close_stdout_07
...
- Directory: `root`
- File list: closeout.c
- Candidate header files: include/close-stream.h, include/closeout.h, include/config.h, include/error.h, include/exitfail.h, include/gettext.h, include/quotearg.h, include/stdio.h, include/unistd.h
...
- Definition location: [closeout.c:49-53]
- Source file: `closeout.c`
- Observed declaration: `void close_stdout_set_file_name (const char *file);`
- Approximate function body length: 5 lines
### `close_stdout_set_ignore_EPIPE`
- Definition location: [closeout.c:86-90]
- Source file: `closeout.c`
- Observed declaration: `void close_stdout_set_ignore_EPIPE (bool ignore);`
- Approximate function body length: 5 lines
### `close_stdout`
- Definition location: [closeout.c:115-135]
- Source file: `closeout.c`
- Observed declaration: `void close_stdout (void);`
...
- `_` [closeout.c:28]: `#define _(msgid) gettext (msgid)`

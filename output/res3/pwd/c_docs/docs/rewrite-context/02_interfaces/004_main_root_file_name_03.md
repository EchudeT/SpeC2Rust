# Interface Facts: main_root_file_name_03
...
- Directory: `root`
- File list: pwd.c
- Candidate header files: include/config.h, include/quote.h, include/root-dev-ino.h, include/stdio.h, include/sys/types.h, include/system.h, include/xgetcwd.h
- Exported functions observed: 6
- Struct definitions observed: 38
...
## Functions
### `file_name_free`
- Definition location: [pwd.c:77-82]
- Source file: `pwd.c`
- Observed declaration: `static void file_name_free (struct file_name *p);`
- Approximate function body length: 6 lines
### `file_name_init`
- Definition location: [pwd.c:84-97]
- Source file: `pwd.c`
- Observed declaration: `static struct file_name * file_name_init (void);`
- Approximate function body length: 14 lines
### `file_name_prepend`
- Definition location: [pwd.c:100-123]
- Source file: `pwd.c`
- Observed declaration: `static void file_name_prepend (struct file_name *p, char const *s, size_t s_len);`
- Approximate function body length: 24 lines
### `find_dir_entry`
- Definition location: [pwd.c:152-242]
- Source file: `pwd.c`
- Observed declaration: `static void find_dir_entry (struct stat *dot_sb, struct file_name *file_name, size_t parent_height);`
- Approximate function body length: 91 lines
### `robust_getcwd`
- Definition location: [pwd.c:267-294]
- Source file: `pwd.c`
- Observed declaration: `static void robust_getcwd (struct file_name *file_name);`
- Approximate function body length: 28 lines
### `main`
- Definition location: [pwd.c:326-394]
- Source file: `pwd.c`
...
- `dirent`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.
- `file_name`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

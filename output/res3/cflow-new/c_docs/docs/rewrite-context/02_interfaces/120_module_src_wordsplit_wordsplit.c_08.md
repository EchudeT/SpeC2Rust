# Interface Facts: module_src_wordsplit_wordsplit.c_08
...
## Functions
### `_wsplt_error`
- Definition location: [src/wordsplit/wordsplit.c:85-94]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void _wsplt_error (const char *fmt, ...);`
- Approximate function body length: 10 lines
### `wsnode_flagstr`
- Definition location: [src/wordsplit/wordsplit.c:432-466]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static const char * wsnode_flagstr (int flags);`
- Approximate function body length: 35 lines
### `wordsplit_append`
- Definition location: [src/wordsplit/wordsplit.c:924-951]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `int wordsplit_append (wordsplit_t *wsp, int argc, char **argv);`
- Approximate function body length: 28 lines
### `find_closing_paren`
- Definition location: [src/wordsplit/wordsplit.c:988-1043]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int find_closing_paren (const char *str, size_t i, size_t len, size_t *poff, char const *paren);`
- Approximate function body length: 56 lines
### `begin_var_p`
- Definition location: [src/wordsplit/wordsplit.c:1725-1729]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int begin_var_p (int c);`
- Approximate function body length: 5 lines
### `begin_cmd_p`
- Definition location: [src/wordsplit/wordsplit.c:1822-1826]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int begin_cmd_p (int c);`
- Approximate function body length: 5 lines
### `isglob`
- Definition location: [src/wordsplit/wordsplit.c:2057-2066]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int isglob (const char *s, int l);`
- Approximate function body length: 10 lines
### `skip_sed_expr`
- Definition location: [src/wordsplit/wordsplit.c:2171-2202]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int skip_sed_expr (const char *command, size_t i, size_t len);`
- Approximate function body length: 32 lines
### `xtonum`
- Definition location: [src/wordsplit/wordsplit.c:2376-2390]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int xtonum (int *pval, const char *src, int base, int cnt);`
- Approximate function body length: 15 lines
### `wsplt_unquote_char`
- Definition location: [src/wordsplit/wordsplit.c:2422-2432]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsplt_unquote_char (const char *transtab, int c);`
- Approximate function body length: 11 lines
### `wsplt_quote_char`
- Definition location: [src/wordsplit/wordsplit.c:2434-2443]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsplt_quote_char (const char *transtab, int c);`
- Approximate function body length: 10 lines
...
- `balance_state`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

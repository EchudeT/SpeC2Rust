# Interface Facts: module_gnu_stdio-read.c_48
...
## Functions
### `scanf`
- Definition location: [gnu/stdio-read.c:88-99]
- Source file: `gnu/stdio-read.c`
- Observed declaration: `int scanf (const char *format, ...);`
- Approximate function body length: 12 lines
### `fscanf`
- Definition location: [gnu/stdio-read.c:105-116]
- Source file: `gnu/stdio-read.c`
- Observed declaration: `int fscanf (FILE *stream, const char *format, ...);`
- Approximate function body length: 12 lines
### `vscanf`
- Definition location: [gnu/stdio-read.c:122-126]
- Source file: `gnu/stdio-read.c`
- Observed declaration: `int vscanf (const char *format, va_list args);`
- Approximate function body length: 5 lines
### `vfscanf`
- Definition location: [gnu/stdio-read.c:132-137]
- Source file: `gnu/stdio-read.c`
- Observed declaration: `int vfscanf (FILE *stream, const char *format, va_list args) #undef vfscanf;`
- Approximate function body length: 6 lines
### `getchar`
- Definition location: [gnu/stdio-read.c:140-144]
- Source file: `gnu/stdio-read.c`
- Observed declaration: `int getchar (void);`
- Approximate function body length: 5 lines
### `fgetc`
- Definition location: [gnu/stdio-read.c:146-151]
- Source file: `gnu/stdio-read.c`
- Observed declaration: `int fgetc (FILE *stream) #undef fgetc;`
- Approximate function body length: 6 lines
### `fgets`
- Definition location: [gnu/stdio-read.c:153-158]
- Source file: `gnu/stdio-read.c`
- Observed declaration: `char * fgets (char *s, int n, FILE *stream) #undef fgets;`
- Approximate function body length: 6 lines
### `fread`
- Definition location: [gnu/stdio-read.c:162-167]
- Source file: `gnu/stdio-read.c`
- Observed declaration: `size_t fread (void *ptr, size_t s, size_t n, FILE *stream) #undef fread;`
- Approximate function body length: 6 lines

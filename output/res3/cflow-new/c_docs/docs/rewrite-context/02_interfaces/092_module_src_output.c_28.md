# Interface Facts: module_src_output.c_28
...
## Functions
### `set_active`
- Definition location: [src/output.c:276-280]
- Source file: `src/output.c`
- Observed declaration: `static void set_active(Symbol *sym);`
- Approximate function body length: 5 lines
### `output`
- Definition location: [src/output.c:424-444]
- Source file: `src/output.c`
- Observed declaration: `void output();`

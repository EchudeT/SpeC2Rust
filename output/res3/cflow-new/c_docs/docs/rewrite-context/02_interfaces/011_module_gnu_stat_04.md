# Interface Facts: module_gnu_stat_04
...
- Directory: `gnu`
- File list: gnu/dup2.c, gnu/fcntl.c, gnu/fstat.c, gnu/open.c, gnu/stat-w32.c, gnu/stat.c
...
## Functions
### `klibc_dup2`
- Definition location: [gnu/dup2.c:140-156]
- Source file: `gnu/dup2.c`
- Observed declaration: `static int klibc_dup2 (int fd, int desired_fd);`
- Approximate function body length: 17 lines
### `klibc_fcntl`
- Definition location: [gnu/fcntl.c:552-629]
...
### `orig_fstat`
- Definition location: [gnu/fstat.c:36-40]
- Source file: `gnu/fstat.c`
- Observed declaration: `static int orig_fstat (int fd, struct stat *buf);`
- Approximate function body length: 5 lines
### `rpl_fstat`
- Definition location: [gnu/fstat.c:69-96]
- Source file: `gnu/fstat.c`
- Observed declaration: `int rpl_fstat (int fd, struct stat *buf);`
- Approximate function body length: 28 lines
### `open`
- Definition location: [gnu/open.c:64-215]
- Source file: `gnu/open.c`
- Observed declaration: `int open (const char *filename, int flags, ...);`
- Approximate function body length: 152 lines
### `_gl_fstat_by_handle`
- Definition location: [gnu/stat-w32.c:162-454]
- Source file: `gnu/stat-w32.c`
- Observed declaration: `int _gl_fstat_by_handle (HANDLE h, const char *path, struct stat *buf);`
- Approximate function body length: 293 lines
### `orig_stat`
- Definition location: [gnu/stat.c:38-42]
- Source file: `gnu/stat.c`
- Observed declaration: `static int orig_stat (const char *filename, struct stat *buf);`
- Approximate function body length: 5 lines

## Structs and Types
### `anonymous`
- Definition location: [gnu/dup2.c:144]
- Source file: `gnu/dup2.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
- Definition location: [gnu/fcntl.c:557]
- Source file: `gnu/fcntl.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
...
- Observed declaration prefix: `struct`
### `anonymous`
- Definition location: [gnu/fstat.c:37]
- Source file: `gnu/fstat.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
- Definition location: [gnu/fstat.c:70]
- Source file: `gnu/fstat.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
...
- Observed declaration prefix: `struct obstack`
### `anonymous`
- Definition location: [gnu/open.c:167]
- Source file: `gnu/open.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
- Definition location: [gnu/open.c:197]
- Source file: `gnu/open.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
...
- Observed declaration prefix: `struct timespec`
### `anonymous`
- Definition location: [gnu/stat-w32.c:114]
- Source file: `gnu/stat-w32.c`
- Observed declaration prefix: `struct timespec`
### `anonymous`
- Definition location: [gnu/stat-w32.c:117]
- Source file: `gnu/stat-w32.c`
- Observed declaration prefix: `struct timespec`
### `anonymous`
- Definition location: [gnu/stat-w32.c:163]
- Source file: `gnu/stat-w32.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
...
- Observed declaration prefix: `struct stat`
### `anonymous`
- Definition location: [gnu/stat.c:39]
- Source file: `gnu/stat.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
- Definition location: [gnu/stat.c:112]
- Source file: `gnu/stat.c`
- Observed declaration prefix: `struct stat`
### `anonymous`

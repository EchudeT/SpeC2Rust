# Interface Facts: module_gnu_vasnprintf.c_54
...
## Functions
### `MAX_ROOM_NEEDED`
- Definition location: [gnu/vasnprintf.c:1644-2201]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static size_t MAX_ROOM_NEEDED (const arguments *ap, size_t arg_index, FCHAR_T conversion, arg_type type, int flags, size_t width, int has_precision, size_t precision, int pad_ourselves);`
- Approximate function body length: 558 lines

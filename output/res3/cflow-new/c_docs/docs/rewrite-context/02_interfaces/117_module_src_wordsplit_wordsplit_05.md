# Interface Facts: module_src_wordsplit_wordsplit_05
...
- Definition location: [src/wordsplit/wordsplit.c:2785-2800]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `void wordsplit_free_parambuf (struct wordsplit *ws);`
- Approximate function body length: 16 lines
### `wordsplit_clearerr`
- Definition location: [src/wordsplit/wordsplit.c:2802-2813]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `void wordsplit_clearerr (struct wordsplit *ws);`
- Approximate function body length: 12 lines
### `wordsplit_free`
- Definition location: [src/wordsplit/wordsplit.c:2815-2829]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `void wordsplit_free (struct wordsplit *ws);`
- Approximate function body length: 15 lines
### `wordsplit_get_words`
- Definition location: [src/wordsplit/wordsplit.c:2831-2846]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `int wordsplit_get_words (struct wordsplit *ws, size_t *wordc, char ***wordv);`
- Approximate function body length: 16 lines
### `wordsplit_strerror`
- Definition location: [src/wordsplit/wordsplit.c:2864-2872]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `const char * wordsplit_strerror (struct wordsplit *ws);`
- Approximate function body length: 9 lines
### `wordsplit_perror`
- Definition location: [src/wordsplit/wordsplit.c:2874-2891]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `void wordsplit_perror (struct wordsplit *wsp);`

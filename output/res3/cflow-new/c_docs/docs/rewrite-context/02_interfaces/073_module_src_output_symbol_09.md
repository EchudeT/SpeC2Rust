# Interface Facts: module_src_output_symbol_09
...
- Directory: `src`
- File list: src/gnu.c, src/output.c, src/posix.c
...
## Functions
### `print_symbol`
- Definition location: [src/gnu.c:41-59]
- Source file: `src/gnu.c`
- Observed declaration: `static int print_symbol(FILE *outfile, int line, struct output_symbol *s);`
- Approximate function body length: 19 lines
### `print_symbol`
- Definition location: [src/output.c:156-170]
- Source file: `src/output.c`
- Observed declaration: `static int print_symbol (int direct, int level, int last, Symbol *sym);`
- Approximate function body length: 15 lines
### `print_symbol`
- Definition location: [src/posix.c:32-47]
- Source file: `src/posix.c`
- Observed declaration: `static int print_symbol(FILE *outfile, int line, struct output_symbol *s);`
...
### `anonymous`
- Definition location: [src/gnu.c:42]
- Source file: `src/gnu.c`
- Observed declaration prefix: `struct output_symbol`
### `anonymous`
...
- Observed declaration prefix: `struct`
### `anonymous`
- Definition location: [src/posix.c:33]
- Source file: `src/posix.c`
- Observed declaration prefix: `struct output_symbol`

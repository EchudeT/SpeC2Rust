# Interface Facts: module_gnu_memchr.c_35
...
## Functions
### `__memchr`
- Definition location: [gnu/memchr.c:60-171]
- Source file: `gnu/memchr.c`
- Observed declaration: `void * __memchr (void const *s, int c_in, size_t n);`

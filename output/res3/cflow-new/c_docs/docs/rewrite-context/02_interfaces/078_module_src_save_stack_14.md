# Interface Facts: module_src_save_stack_14
...
## Functions
### `save_stack`
- Definition location: [src/parser.c:411-416]
- Source file: `src/parser.c`
- Observed declaration: `void save_stack();`
- Approximate function body length: 6 lines
### `save_stack_is_empty`
- Definition location: [src/parser.c:424-428]
- Source file: `src/parser.c`
- Observed declaration: `int save_stack_is_empty();`

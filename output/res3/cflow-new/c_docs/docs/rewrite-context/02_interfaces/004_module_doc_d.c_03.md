# Interface Facts: module_doc_d.c_03
...
- Directory: `doc`
- File list: doc/d.c
- Candidate header files: gnu/stdio.h, gnu/stdlib.h, gnu/string.h, gnu/sys/stat.h, gnu/sys/types.h, gnu/unistd.h
...
## Functions
### `isdir`
- Definition location: [doc/d.c:11-22]
- Source file: `doc/d.c`
- Observed declaration: `static int isdir (char *name);`
- Approximate function body length: 12 lines
### `ignorent`
- Definition location: [doc/d.c:27-35]
- Source file: `doc/d.c`
- Observed declaration: `int ignorent (char *name);`
- Approximate function body length: 9 lines
### `printdir`
- Definition location: [doc/d.c:41-82]
- Source file: `doc/d.c`
- Observed declaration: `void printdir (int level, char *name);`
- Approximate function body length: 42 lines

## Structs and Types
### `anonymous`
- Definition location: [doc/d.c:14]
- Source file: `doc/d.c`
- Observed declaration prefix: `struct stat`
### `anonymous`
- Definition location: [doc/d.c:45]
- Source file: `doc/d.c`
...
- `_GL_CXXALIAS_RPL` [gnu/stdlib.h:360-361]: `#define _GL_CXXALIAS_RPL(func,rettype,parameters) \ _GL_CXXALIAS_RPL_1 (func, rpl_##func, rettype, parameters)`

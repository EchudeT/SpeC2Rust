# Interface Facts: module_src_wordsplit_wordsplit_02
...
## Functions
### `wsnode_insert`
- Definition location: [src/wordsplit/wordsplit.c:552-588]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void wsnode_insert (struct wordsplit *wsp, struct wordsplit_node *node, struct wordsplit_node *anchor, int before);`
- Approximate function body length: 37 lines
### `wordsplit_add_segm`
- Definition location: [src/wordsplit/wordsplit.c:590-606]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wordsplit_add_segm (struct wordsplit *wsp, size_t beg, size_t end, int flg);`
- Approximate function body length: 17 lines
### `wordsplit_free_nodes`
- Definition location: [src/wordsplit/wordsplit.c:608-620]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void wordsplit_free_nodes (struct wordsplit *wsp);`
- Approximate function body length: 13 lines
### `wordsplit_dump_nodes`
- Definition location: [src/wordsplit/wordsplit.c:622-641]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void wordsplit_dump_nodes (struct wordsplit *wsp);`
- Approximate function body length: 20 lines
### `coalesce_segment`
- Definition location: [src/wordsplit/wordsplit.c:643-695]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int coalesce_segment (struct wordsplit *wsp, struct wordsplit_node *node);`
- Approximate function body length: 53 lines
### `wsnode_quoteremoval`
- Definition location: [src/wordsplit/wordsplit.c:701-729]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsnode_quoteremoval (struct wordsplit *wsp);`
- Approximate function body length: 29 lines
### `wsnode_coalesce`
- Definition location: [src/wordsplit/wordsplit.c:731-743]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsnode_coalesce (struct wordsplit *wsp);`
- Approximate function body length: 13 lines
### `wsnode_tail_coalesce`
- Definition location: [src/wordsplit/wordsplit.c:745-760]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsnode_tail_coalesce (struct wordsplit *wsp, struct wordsplit_node *p);`
- Approximate function body length: 16 lines
### `wordsplit_finish`
- Definition location: [src/wordsplit/wordsplit.c:764-922]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wordsplit_finish (struct wordsplit *wsp);`
- Approximate function body length: 159 lines
### `node_split_prefix`
- Definition location: [src/wordsplit/wordsplit.c:954-986]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int node_split_prefix (struct wordsplit *wsp, struct wordsplit_node **ptail, struct wordsplit_node *node, size_t beg, size_t len, int flg);`
- Approximate function body length: 33 lines
### `wsplt_env_find`
- Definition location: [src/wordsplit/wordsplit.c:1045-1082]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static char const * wsplt_env_find (struct wordsplit *wsp, const char *name, size_t len);`
- Approximate function body length: 38 lines
### `wsplt_env_lookup`
- Definition location: [src/wordsplit/wordsplit.c:1084-1101]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsplt_env_lookup (struct wordsplit *wsp, const char *name, size_t len, char **ret);`
- Approximate function body length: 18 lines
### `wsplt_env_getvar`
- Definition location: [src/wordsplit/wordsplit.c:1103-1108]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsplt_env_getvar (struct wordsplit *wsp, const char *name, size_t len, char **ret);`
- Approximate function body length: 6 lines
### `wsplt_assign_var`
- Definition location: [src/wordsplit/wordsplit.c:1110-1216]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsplt_assign_var (struct wordsplit *wsp, const char *name, size_t namelen, char const *value);`
- Approximate function body length: 107 lines
### `wsplt_assign_param`
- Definition location: [src/wordsplit/wordsplit.c:1218-1280]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsplt_assign_param (struct wordsplit *wsp, int param_idx, char *value);`

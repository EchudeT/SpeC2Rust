# Interface Facts: module_gnu_open.c_39
...
## Functions
### `orig_open`
- Definition location: [gnu/open.c:32-40]
- Source file: `gnu/open.c`
- Observed declaration: `static int orig_open (const char *filename, int flags, mode_t mode);`

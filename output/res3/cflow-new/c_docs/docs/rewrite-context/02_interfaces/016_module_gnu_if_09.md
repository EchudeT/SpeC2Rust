# Interface Facts: module_gnu_if_09
...
- Directory: `gnu`
- File list: gnu/printf-parse.c, gnu/vasnprintf.c
...
## Functions
### `if`
- Definition location: [gnu/printf-parse.c:682-686]
- Source file: `gnu/printf-parse.c`
- Observed declaration: `else if (!c_isascii (c));`
- Approximate function body length: 5 lines
### `if`
- Definition location: [gnu/vasnprintf.c:2387-2768]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `else if (dp->conversion == 'U');`
- Approximate function body length: 382 lines

# Interface Facts: module_src_posix.c_33
...
## Functions
### `print_symbol_type`
- Definition location: [src/posix.c:20-30]
- Source file: `src/posix.c`
- Observed declaration: `static void print_symbol_type(FILE *outfile, Symbol *sym);`
- Approximate function body length: 11 lines
### `posix_output_handler`
- Definition location: [src/posix.c:49-76]
- Source file: `src/posix.c`
- Observed declaration: `int posix_output_handler(cflow_output_command cmd, FILE *outfile, int line, void *data, void *handler_data);`

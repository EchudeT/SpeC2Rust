# Interface Facts: module_doc_whoami.c_06
...
- Directory: `doc`
- File list: doc/whoami.c
- Candidate header files: gnu/stdio.h, gnu/stdlib.h, gnu/sys/types.h
- Exported functions observed: 1
- Struct definitions observed: 16
...
## Functions
### `who_am_i`
- Definition location: [doc/whoami.c:7-23]
- Source file: `doc/whoami.c`
- Observed declaration: `int who_am_i (void);`

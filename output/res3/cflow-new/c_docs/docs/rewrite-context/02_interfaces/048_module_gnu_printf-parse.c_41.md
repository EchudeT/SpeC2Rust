# Interface Facts: module_gnu_printf-parse.c_41
...
## Functions
### `PRINTF_PARSE`
- Definition location: [gnu/printf-parse.c:75-117]
- Source file: `gnu/printf-parse.c`
- Observed declaration: `int PRINTF_PARSE (const CHAR_T *format, DIRECTIVES *d, arguments *a);`
- Approximate function body length: 43 lines

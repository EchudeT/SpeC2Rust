# Interface Facts: module_src_symbol.c_34
...
- Definition location: [src/symbol.c:30-37]
- Source file: `src/symbol.c`
- Observed declaration: `static void symbol_unlink_from_list(Symbol *sp);`
- Approximate function body length: 8 lines
### `ident_change_storage`
- Definition location: [src/symbol.c:139-160]
- Source file: `src/symbol.c`
- Observed declaration: `void ident_change_storage(Symbol *sp, enum storage storage);`
- Approximate function body length: 22 lines
### `init_ident`
- Definition location: [src/symbol.c:162-175]
- Source file: `src/symbol.c`
- Observed declaration: `void init_ident(Symbol *sp, enum storage storage);`
- Approximate function body length: 14 lines
### `install_ident`
- Definition location: [src/symbol.c:177-187]
- Source file: `src/symbol.c`
- Observed declaration: `Symbol * install_ident(char *name, enum storage storage);`
- Approximate function body length: 11 lines
### `delete_symbol`
- Definition location: [src/symbol.c:212-224]
- Source file: `src/symbol.c`
- Observed declaration: `static void delete_symbol(Symbol *sym);`
- Approximate function body length: 13 lines
### `delete_statics`
- Definition location: [src/symbol.c:260-268]
- Source file: `src/symbol.c`
- Observed declaration: `void delete_statics();`
- Approximate function body length: 9 lines
### `delete_autos`
- Definition location: [src/symbol.c:298-303]
- Source file: `src/symbol.c`
- Observed declaration: `void delete_autos(int level);`
- Approximate function body length: 6 lines
### `delete_parms`
- Definition location: [src/symbol.c:406-410]
- Source file: `src/symbol.c`
- Observed declaration: `void delete_parms(int level);`
- Approximate function body length: 5 lines
### `install_starter`
- Definition location: [src/symbol.c:430-438]
- Source file: `src/symbol.c`
- Observed declaration: `Symbol * install_starter(char *name);`
- Approximate function body length: 9 lines
### `set_default_starter`
- Definition location: [src/symbol.c:440-445]
- Source file: `src/symbol.c`
- Observed declaration: `void set_default_starter(void);`
- Approximate function body length: 6 lines
### `clear_starters`
- Definition location: [src/symbol.c:447-451]
- Source file: `src/symbol.c`
- Observed declaration: `void clear_starters(void);`
- Approximate function body length: 5 lines
### `install_target`
- Definition location: [src/symbol.c:489-497]
- Source file: `src/symbol.c`
- Observed declaration: `Symbol * install_target(char *name);`
- Approximate function body length: 9 lines

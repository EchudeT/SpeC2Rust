# Interface Facts: module_gnu_asnprintf.c_20
...
## Functions
### `asnprintf`
- Definition location: [gnu/asnprintf.c:26-36]
- Source file: `gnu/asnprintf.c`
- Observed declaration: `char * asnprintf (char *resultbuf, size_t *lengthp, const char *format, ...);`

# Interface Facts: module_gnu_strerror-override.c_50
...
- Directory: `gnu`
- File list: gnu/strerror-override.c
...
## Functions
### `strerror_override`
- Definition location: [gnu/strerror-override.c:38-306]
- Source file: `gnu/strerror-override.c`
- Observed declaration: `const char * strerror_override (int errnum);`
- Approximate function body length: 269 lines

# Interface Facts: module_gnu_close.c_24
...
## Functions
### `close_nothrow`
- Definition location: [gnu/close.c:35-43]
- Source file: `gnu/close.c`
- Observed declaration: `static int close_nothrow (int fd);`
- Approximate function body length: 9 lines
### `rpl_close`
- Definition location: [gnu/close.c:62-77]
- Source file: `gnu/close.c`
- Observed declaration: `int rpl_close (int fd);`

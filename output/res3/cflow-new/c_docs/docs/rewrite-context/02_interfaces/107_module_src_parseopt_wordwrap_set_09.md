# Interface Facts: module_src_parseopt_wordwrap_set_09
...
- Definition location: [src/parseopt/wordwrap.c:456-496]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `int wordwrap_set_left_margin (WORDWRAP_FILE wf, unsigned left);`
- Approximate function body length: 41 lines
### `wordwrap_set_right_margin`
- Definition location: [src/parseopt/wordwrap.c:520-558]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `int wordwrap_set_right_margin (WORDWRAP_FILE wf, unsigned right);`

# Interface Facts: module_src_yy_init_18
...
## Functions
### `yy_init_buffer`
- Definition location: [src/c.c:2227-2261]
- Source file: `src/c.c`
- Observed declaration: `static void yy_init_buffer (YY_BUFFER_STATE b, FILE * file ) /* %endif */ /* %if-c++-only */ /* %endif */;`
- Approximate function body length: 35 lines
### `yy_init_globals`
- Definition location: [src/c.c:2628-2654]
- Source file: `src/c.c`
- Observed declaration: `static int yy_init_globals (void);`

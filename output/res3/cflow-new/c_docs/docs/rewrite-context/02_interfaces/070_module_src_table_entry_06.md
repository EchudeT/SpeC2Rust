# Interface Facts: module_src_table_entry_06
...
## Functions
### `hash_symbol_hasher`
- Definition location: [src/symbol.c:54-61]
- Source file: `src/symbol.c`
- Observed declaration: `static size_t hash_symbol_hasher(void const *data, size_t n_buckets);`
- Approximate function body length: 8 lines
### `hash_symbol_compare`
- Definition location: [src/symbol.c:64-70]
- Source file: `src/symbol.c`
- Observed declaration: `static bool hash_symbol_compare(void const *data1, void const *data2);`
- Approximate function body length: 7 lines
### `lookup`
- Definition location: [src/symbol.c:72-90]
- Source file: `src/symbol.c`
- Observed declaration: `Symbol * lookup(const char *name);`
- Approximate function body length: 19 lines
### `install`
- Definition location: [src/symbol.c:94-137]
- Source file: `src/symbol.c`
- Observed declaration: `Symbol * install(char *name, int flags);`
- Approximate function body length: 44 lines
### `unlink_symbol`
- Definition location: [src/symbol.c:190-209]
- Source file: `src/symbol.c`
- Observed declaration: `static void unlink_symbol(Symbol *sym);`
- Approximate function body length: 20 lines
### `static_free`
- Definition location: [src/symbol.c:235-258]
- Source file: `src/symbol.c`
- Observed declaration: `static void static_free(void *data);`
- Approximate function body length: 24 lines
### `collect_processor`
- Definition location: [src/symbol.c:312-327]
- Source file: `src/symbol.c`
- Observed declaration: `static bool collect_processor(void *data, void *proc_data);`
- Approximate function body length: 16 lines
### `delete_parms_itr`
- Definition location: [src/symbol.c:388-403]
- Source file: `src/symbol.c`
- Observed declaration: `int delete_parms_itr(void *data, void *call_data);`
- Approximate function body length: 16 lines
...
- `collect_data`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.
- `table_entry`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

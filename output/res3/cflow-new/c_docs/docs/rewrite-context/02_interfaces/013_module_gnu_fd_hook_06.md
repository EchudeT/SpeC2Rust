# Interface Facts: module_gnu_fd_hook_06
...
- Struct definitions observed: 134
...
## Functions
### `execute_close_hooks`
- Definition location: [gnu/fd-hook.c:35-45]
- Source file: `gnu/fd-hook.c`
- Observed declaration: `int execute_close_hooks (const struct fd_hook *remaining_list, gl_close_fn primary, int fd);`
- Approximate function body length: 11 lines
### `execute_ioctl_hooks`
- Definition location: [gnu/fd-hook.c:53-63]
- Source file: `gnu/fd-hook.c`
- Observed declaration: `int execute_ioctl_hooks (const struct fd_hook *remaining_list, gl_ioctl_fn primary, int fd, int request, void *arg);`
- Approximate function body length: 11 lines
### `register_fd_hook`
- Definition location: [gnu/fd-hook.c:72-97]
- Source file: `gnu/fd-hook.c`
- Observed declaration: `void register_fd_hook (close_hook_fn close_hook, ioctl_hook_fn ioctl_hook, struct fd_hook *link);`
- Approximate function body length: 26 lines
### `unregister_fd_hook`
- Definition location: [gnu/fd-hook.c:99-116]
- Source file: `gnu/fd-hook.c`
- Observed declaration: `void unregister_fd_hook (struct fd_hook *link);`
- Approximate function body length: 18 lines

## Structs and Types
### `anonymous`
- Definition location: [gnu/fd-hook.c:33]
- Source file: `gnu/fd-hook.c`
- Observed declaration prefix: `struct fd_hook`
### `anonymous`
- Definition location: [gnu/fd-hook.c:36]
- Source file: `gnu/fd-hook.c`
- Observed declaration prefix: `struct fd_hook`
### `anonymous`
- Definition location: [gnu/fd-hook.c:54]
- Source file: `gnu/fd-hook.c`
- Observed declaration prefix: `struct fd_hook`
### `anonymous`
- Definition location: [gnu/fd-hook.c:73]
- Source file: `gnu/fd-hook.c`
- Observed declaration prefix: `struct fd_hook`
### `anonymous`
- Definition location: [gnu/fd-hook.c:100]
- Source file: `gnu/fd-hook.c`
- Observed declaration prefix: `struct fd_hook`
### `anonymous`
- Definition location: [gnu/fd-hook.c:102]
- Source file: `gnu/fd-hook.c`
- Observed declaration prefix: `struct fd_hook`
### `anonymous`
- Definition location: [gnu/fd-hook.c:103]
- Source file: `gnu/fd-hook.c`
- Observed declaration prefix: `struct fd_hook`
### `anonymous`
...
- `fd_hook`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

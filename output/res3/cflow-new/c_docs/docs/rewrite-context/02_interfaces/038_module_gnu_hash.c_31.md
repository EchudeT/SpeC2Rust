# Interface Facts: module_gnu_hash.c_31
...
- Definition location: [gnu/hash.c:215-230]
- Source file: `gnu/hash.c`
- Observed declaration: `void hash_print_statistics (const Hash_table *table, FILE *stream);`
- Approximate function body length: 16 lines
### `hash_reset_tuning`
- Definition location: [gnu/hash.c:433-437]
- Source file: `gnu/hash.c`
- Observed declaration: `void hash_reset_tuning (Hash_tuning *tuning);`
- Approximate function body length: 5 lines
### `raw_hasher`
- Definition location: [gnu/hash.c:440-450]
- Source file: `gnu/hash.c`
- Observed declaration: `static size_t raw_hasher (const void *data, size_t n);`
- Approximate function body length: 11 lines
### `raw_comparator`
- Definition location: [gnu/hash.c:453-457]
- Source file: `gnu/hash.c`
- Observed declaration: `static bool raw_comparator (const void *a, const void *b);`
- Approximate function body length: 5 lines
### `check_tuning`
- Definition location: [gnu/hash.c:466-492]
- Source file: `gnu/hash.c`
- Observed declaration: `static bool check_tuning (Hash_table *table);`
- Approximate function body length: 27 lines
### `hash_initialize`
- Definition location: [gnu/hash.c:518-572]
- Source file: `gnu/hash.c`
- Observed declaration: `Hash_table * hash_initialize (size_t candidate, const Hash_tuning *tuning, Hash_hasher hasher, Hash_comparator comparator, Hash_data_freer data_freer);`
- Approximate function body length: 55 lines
### `hash_rehash`
- Definition location: [gnu/hash.c:854-933]
- Source file: `gnu/hash.c`
- Observed declaration: `bool hash_rehash (Hash_table *table, size_t candidate);`
- Approximate function body length: 80 lines
### `hash_insert`
- Definition location: [gnu/hash.c:1020-1028]
- Source file: `gnu/hash.c`
- Observed declaration: `void * hash_insert (Hash_table *table, void const *entry);`
- Approximate function body length: 9 lines
### `hash_delete`
- Definition location: [gnu/hash.c:1090-1094]
- Source file: `gnu/hash.c`
- Observed declaration: `void * hash_delete (Hash_table *table, const void *entry);`
- Approximate function body length: 5 lines

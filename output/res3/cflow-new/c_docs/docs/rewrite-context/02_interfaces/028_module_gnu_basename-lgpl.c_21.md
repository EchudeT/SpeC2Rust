# Interface Facts: module_gnu_basename-lgpl.c_21
...
## Functions
### `last_component`
- Definition location: [gnu/basename-lgpl.c:30-52]
- Source file: `gnu/basename-lgpl.c`
- Observed declaration: `char * last_component (char const *name);`
- Approximate function body length: 23 lines
### `base_len`
- Definition location: [gnu/basename-lgpl.c:54-72]
- Source file: `gnu/basename-lgpl.c`
- Observed declaration: `size_t base_len (char const *name);`

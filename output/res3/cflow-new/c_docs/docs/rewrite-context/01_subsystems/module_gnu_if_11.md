...
- `if` [gnu/vasnprintf.c:3560-3628]: `else if (dp->conversion == 'c' && a.arg[dp->arg_index].type != TYPE_WIDE_CHAR);`
- `if` [gnu/vasnprintf.c:5301-5551]: `else if (dp->conversion == 'g' || dp->conversion == 'G');`

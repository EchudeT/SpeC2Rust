...
- Observed focus: organized around functions with the `wordwrap_at` prefix
...
- `wordwrap_at_bol` [src/parseopt/wordwrap.c:208-212]: `int wordwrap_at_bol (WORDWRAP_FILE wf);`
- `wordwrap_at_eol` [src/parseopt/wordwrap.c:217-221]: `int wordwrap_at_eol (WORDWRAP_FILE wf);`

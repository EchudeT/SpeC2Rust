...
- `optfile_lookup` [src/main.c:1141-1218]: `static int optfile_lookup(char const *name, struct parseopt_file *pf);`
- `parseopt_from_rc` [src/main.c:1253-1283]: `static int parseopt_from_rc(char const *file_name);`

...
- Observed focus: organized around functions with the `is_unc_root` prefix
- Module category: `module_cluster`
- Directory scope: `gnu`

## 2. Inputs and Outputs
- At this stage, do not speculate about runtime I/O; define interface boundaries by the observed function signatures and source files.
- File input boundary: gnu/stat.c
- Function count: 1

## 3. Core Interface List
- `is_unc_root` [gnu/stat.c:79-102]: `static BOOL is_unc_root (const char *rname);`

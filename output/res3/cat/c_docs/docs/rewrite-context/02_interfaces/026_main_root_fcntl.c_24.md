# Interface Facts: main_root_fcntl.c_24
...
## Functions
### `dupfd`
- Definition location: [fcntl.c:54-167]
- Source file: `fcntl.c`
- Observed declaration: `static int dupfd (int oldfd, int newfd, int flags);`
- Approximate function body length: 114 lines

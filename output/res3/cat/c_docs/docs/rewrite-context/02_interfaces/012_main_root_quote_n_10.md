# Interface Facts: main_root_quote_n_10
...
## Functions
### `quote_n_mem`
- Definition location: [quotearg.c:1055-1059]
- Source file: `quotearg.c`
- Observed declaration: `har const * quote_n_mem (int n, char const *arg, size_t argsize);`
- Approximate function body length: 5 lines
### `quote_n`
- Definition location: [quotearg.c:1067-1071]
- Source file: `quotearg.c`
- Observed declaration: `har const * quote_n (int n, char const *arg);`
- Approximate function body length: 5 lines

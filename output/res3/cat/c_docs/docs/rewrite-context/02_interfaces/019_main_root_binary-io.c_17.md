# Interface Facts: main_root_binary-io.c_17
...
- Directory: `root`
- File list: binary-io.c
- Candidate header files: include/binary-io.h, include/config.h
...
## Functions
### `set_binary_mode`
- Definition location: [binary-io.c:25-37]
- Source file: `binary-io.c`
- Observed declaration: `int set_binary_mode (int fd, int mode);`
...
- `BINARY_IO_INLINE` [binary-io.c:19]: `#define BINARY_IO_INLINE _GL_EXTERN_INLINE`
- `_BINARY_H` [include/binary-io.h:18]: `#define _BINARY_H`
- `SET_BINARY` [include/binary-io.h:80]: `#define SET_BINARY(fd) ((void) set_binary_mode (fd, O_BINARY))`

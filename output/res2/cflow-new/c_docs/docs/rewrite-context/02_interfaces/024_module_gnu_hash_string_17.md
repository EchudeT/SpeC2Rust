# Interface Facts: module_gnu_hash_string_17
...
## Functions
### `hash_string`
- Definition location: [gnu/hash.c:359-373]
- Source file: `gnu/hash.c`
- Observed declaration: `size_t hash_string (const char *string, size_t n_buckets);`
- Approximate function body length: 15 lines
### `hash_string`
- Definition location: [gnu/hash.c:382-391]
- Source file: `gnu/hash.c`
- Observed declaration: `size_t hash_string (const char *string, size_t n_buckets);`

# Interface Facts: module_src_wordsplit_wordsplit_03
...
## Functions
### `expvar_recover`
- Definition location: [src/wordsplit/wordsplit.c:1284-1303]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int expvar_recover (struct wordsplit *wsp, const char *str, struct wordsplit_node **ptail, const char **pend, int flg);`
- Approximate function body length: 20 lines
### `expand_paramv`
- Definition location: [src/wordsplit/wordsplit.c:1305-1376]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int expand_paramv (struct wordsplit *wsp, struct wordsplit_node **ptail, int flg, int q);`
- Approximate function body length: 72 lines
### `expvar`
- Definition location: [src/wordsplit/wordsplit.c:1378-1723]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int expvar (struct wordsplit *wsp, const char *str, size_t len, struct wordsplit_node **ptail, const char **pend, int flg);`
- Approximate function body length: 346 lines
### `node_expand`
- Definition location: [src/wordsplit/wordsplit.c:1731-1783]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int node_expand (struct wordsplit *wsp, struct wordsplit_node *node, int (*beg_p) (int), int (*ws_exp_fn) (struct wordsplit *wsp, const char *str, size_t len, struct wordsplit_node **ptail, const char **pend, i...`
- Approximate function body length: 53 lines
### `wsnode_nullelim`
- Definition location: [src/wordsplit/wordsplit.c:1786-1802]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void wsnode_nullelim (struct wordsplit *wsp);`
- Approximate function body length: 17 lines
### `wordsplit_varexp`
- Definition location: [src/wordsplit/wordsplit.c:1804-1820]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wordsplit_varexp (struct wordsplit *wsp);`
- Approximate function body length: 17 lines
### `expcmd`
- Definition location: [src/wordsplit/wordsplit.c:1828-1925]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int expcmd (struct wordsplit *wsp, const char *str, size_t len, struct wordsplit_node **ptail, const char **pend, int flg);`
- Approximate function body length: 98 lines
### `wordsplit_cmdexp`
- Definition location: [src/wordsplit/wordsplit.c:1927-1943]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wordsplit_cmdexp (struct wordsplit *wsp);`
- Approximate function body length: 17 lines
### `wordsplit_trimws`
- Definition location: [src/wordsplit/wordsplit.c:1948-1982]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wordsplit_trimws (struct wordsplit *wsp);`

# Interface Facts: module_gnu_xmalloc.c_56
...
### `xzalloc`
- Definition location: [gnu/xmalloc.c:282-286]
- Source file: `gnu/xmalloc.c`
- Observed declaration: `void * xzalloc (size_t s);`
- Approximate function body length: 5 lines
### `xizalloc`
- Definition location: [gnu/xmalloc.c:288-292]
- Source file: `gnu/xmalloc.c`
- Observed declaration: `void * xizalloc (idx_t s);`
- Approximate function body length: 5 lines
### `xcalloc`
- Definition location: [gnu/xmalloc.c:297-301]
- Source file: `gnu/xmalloc.c`
- Observed declaration: `void * xcalloc (size_t n, size_t s);`
- Approximate function body length: 5 lines

# Interface Facts: module_gnu_malloca.c_34
...
## Functions
### `mmalloca`
- Definition location: [gnu/malloca.c:54-104]
- Source file: `gnu/malloca.c`
- Observed declaration: `mmalloca (size_t n);`
- Approximate function body length: 51 lines
### `freea`
- Definition location: [gnu/malloca.c:107-129]
- Source file: `gnu/malloca.c`
- Observed declaration: `(void *p);`

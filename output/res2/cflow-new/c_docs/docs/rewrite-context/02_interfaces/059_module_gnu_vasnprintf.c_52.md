# Interface Facts: module_gnu_vasnprintf.c_52
...
## Functions
### `local_strnlen`
- Definition location: [gnu/vasnprintf.c:242-247]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static size_t local_strnlen (const char *string, size_t maxlen);`
- Approximate function body length: 6 lines
### `local_wcslen`
- Definition location: [gnu/vasnprintf.c:262-270]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static size_t local_wcslen (const wchar_t *s);`
- Approximate function body length: 9 lines
### `local_wcsnlen`
- Definition location: [gnu/vasnprintf.c:281-289]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static size_t local_wcsnlen (const wchar_t *s, size_t maxlen);`
- Approximate function body length: 9 lines
### `wctomb_fallback`
- Definition location: [gnu/vasnprintf.c:296-332]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static size_t wctomb_fallback (char *s, wchar_t wc);`
- Approximate function body length: 37 lines
### `local_wcrtomb`
- Definition location: [gnu/vasnprintf.c:334-341]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static size_t local_wcrtomb (char *s, wchar_t wc, mbstate_t *ps);`
- Approximate function body length: 8 lines
### `local_wctomb`
- Definition location: [gnu/vasnprintf.c:343-350]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static int local_wctomb (char *s, wchar_t wc);`
- Approximate function body length: 8 lines
### `decimal_point_char`
- Definition location: [gnu/vasnprintf.c:366-385]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static char decimal_point_char (void);`
- Approximate function body length: 20 lines
### `multiply`
- Definition location: [gnu/vasnprintf.c:435-498]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static void * multiply (mpn_t src1, mpn_t src2, mpn_t *dest);`
- Approximate function body length: 64 lines
### `divide`
- Definition location: [gnu/vasnprintf.c:507-930]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static void * divide (mpn_t a, mpn_t b, mpn_t *q);`
- Approximate function body length: 424 lines
### `convert_to_decimal`
- Definition location: [gnu/vasnprintf.c:946-994]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static char * convert_to_decimal (mpn_t a, size_t extra_zeroes);`
- Approximate function body length: 49 lines

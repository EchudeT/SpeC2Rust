# Interface Facts: module_src_dot.c_24
...
- Struct definitions observed: 29
...
## Functions
### `dot_begin`
- Definition location: [src/dot.c:18-23]
- Source file: `src/dot.c`
- Observed declaration: `static void dot_begin(FILE *fp);`
- Approximate function body length: 6 lines
### `declare_node`
- Definition location: [src/dot.c:25-35]
- Source file: `src/dot.c`
- Observed declaration: `static void declare_node(FILE *fp, Symbol *sym);`
- Approximate function body length: 11 lines
### `dot_output_handler`
- Definition location: [src/dot.c:60-78]
- Source file: `src/dot.c`
- Observed declaration: `int dot_output_handler(cflow_output_command cmd, FILE *outfile, int line, void *data, void *handler_data);`

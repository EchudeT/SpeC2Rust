# Interface Facts: module_gnu_dup2.c_25
...
## Functions
### `dup2_nothrow`
- Definition location: [gnu/dup2.c:50-58]
- Source file: `gnu/dup2.c`
- Observed declaration: `static int dup2_nothrow (int fd, int desired_fd);`
- Approximate function body length: 9 lines
### `ms_windows_dup2`
- Definition location: [gnu/dup2.c:72-104]
- Source file: `gnu/dup2.c`
- Observed declaration: `static int ms_windows_dup2 (int fd, int desired_fd);`
- Approximate function body length: 33 lines
### `klibc_dup2dirfd`
- Definition location: [gnu/dup2.c:112-138]
- Source file: `gnu/dup2.c`
- Observed declaration: `static int klibc_dup2dirfd (int fd, int desired_fd);`
- Approximate function body length: 27 lines
### `rpl_dup2`
- Definition location: [gnu/dup2.c:161-191]
- Source file: `gnu/dup2.c`
- Observed declaration: `int rpl_dup2 (int fd, int desired_fd);`

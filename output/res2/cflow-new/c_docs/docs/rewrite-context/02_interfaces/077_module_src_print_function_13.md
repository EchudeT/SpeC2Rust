# Interface Facts: module_src_print_function_13
...
- Directory: `src`
- File list: src/gnu.c, src/output.c
...
## Functions
### `print_function_name`
- Definition location: [src/gnu.c:19-38]
- Source file: `src/gnu.c`
- Observed declaration: `void print_function_name(Symbol *sym, int has_subtree);`
- Approximate function body length: 20 lines
### `print_function`
- Definition location: [src/output.c:223-234]
- Source file: `src/output.c`
- Observed declaration: `static void print_function(Symbol *symp);`

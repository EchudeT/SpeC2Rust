# Interface Facts: module_src_parseopt_help.c_11
...
## Functions
### `min`
- Definition location: [src/parseopt/help.c:339-343]
- Source file: `src/parseopt/help.c`
- Observed declaration: `static inline size_t min (size_t a, size_t b);`

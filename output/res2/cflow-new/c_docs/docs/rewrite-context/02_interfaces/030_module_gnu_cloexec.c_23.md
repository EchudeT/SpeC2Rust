# Interface Facts: module_gnu_cloexec.c_23
...
## Functions
### `set_cloexec_flag`
- Definition location: [gnu/cloexec.c:40-74]
- Source file: `gnu/cloexec.c`
- Observed declaration: `int set_cloexec_flag (int desc, bool value);`
- Approximate function body length: 35 lines
### `dup_cloexec`
- Definition location: [gnu/cloexec.c:81-85]
- Source file: `gnu/cloexec.c`
- Observed declaration: `int dup_cloexec (int fd);`

# Interface Facts: module_src_set_level_15
...
- Directory: `src`
- File list: src/main.c, src/output.c
...
- Struct definitions observed: 185
...
## Functions
### `set_level_indent`
- Definition location: [src/main.c:324-367]
- Source file: `src/main.c`
- Observed declaration: `static void set_level_indent(const char *str);`
- Approximate function body length: 44 lines
### `set_level_mark`
- Definition location: [src/output.c:30-38]
- Source file: `src/output.c`
- Observed declaration: `static void set_level_mark(int lev, int mark);`

# Interface Facts: module_gnu_gl_msvc_inval_per_thread_07
...
- Definition location: [gnu/msvc-inval.c:33-40]
- Source file: `gnu/msvc-inval.c`
- Observed declaration: `static void __cdecl gl_msvc_invalid_parameter_handler (const wchar_t *expression, const wchar_t *function, const wchar_t *file, unsigned int line, uintptr_t dummy);`
- Approximate function body length: 8 lines
### `gl_msvc_invalid_parameter_handler`
- Definition location: [gnu/msvc-inval.c:50-58]
- Source file: `gnu/msvc-inval.c`
- Observed declaration: `static void __cdecl gl_msvc_invalid_parameter_handler (const wchar_t *expression, const wchar_t *function, const wchar_t *file, unsigned int line, uintptr_t dummy);`
- Approximate function body length: 9 lines
### `gl_msvc_inval_current`
- Definition location: [gnu/msvc-inval.c:69-97]
- Source file: `gnu/msvc-inval.c`
- Observed declaration: `struct gl_msvc_inval_per_thread * gl_msvc_inval_current (void);`
- Approximate function body length: 29 lines
### `gl_msvc_invalid_parameter_handler`
- Definition location: [gnu/msvc-inval.c:99-113]
- Source file: `gnu/msvc-inval.c`
- Observed declaration: `static void __cdecl gl_msvc_invalid_parameter_handler (const wchar_t *expression, const wchar_t *function, const wchar_t *file, unsigned int line, uintptr_t dummy);`
...
- Observed declaration prefix: `struct`
### `anonymous`
- Definition location: [gnu/msvc-inval.c:67]
- Source file: `gnu/msvc-inval.c`
- Observed declaration prefix: `struct gl_msvc_inval_per_thread`
### `anonymous`
- Definition location: [gnu/msvc-inval.c:69]
- Source file: `gnu/msvc-inval.c`
- Observed declaration prefix: `struct gl_msvc_inval_per_thread`
### `anonymous`
- Definition location: [gnu/msvc-inval.c:82]
- Source file: `gnu/msvc-inval.c`
- Observed declaration prefix: `struct gl_msvc_inval_per_thread`
### `anonymous`
- Definition location: [gnu/msvc-inval.c:83]
- Source file: `gnu/msvc-inval.c`
- Observed declaration prefix: `struct gl_msvc_inval_per_thread`
### `anonymous`
- Definition location: [gnu/msvc-inval.c:88]
- Source file: `gnu/msvc-inval.c`
- Observed declaration prefix: `struct gl_msvc_inval_per_thread`
### `anonymous`
- Definition location: [gnu/msvc-inval.c:89]
- Source file: `gnu/msvc-inval.c`
- Observed declaration prefix: `struct gl_msvc_inval_per_thread`
### `anonymous`
- Definition location: [gnu/msvc-inval.c:106]
- Source file: `gnu/msvc-inval.c`
- Observed declaration prefix: `struct gl_msvc_inval_per_thread`
### `anonymous`
...
- `gl_msvc_inval_per_thread`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

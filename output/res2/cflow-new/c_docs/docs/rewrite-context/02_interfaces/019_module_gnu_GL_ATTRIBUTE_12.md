# Interface Facts: module_gnu_GL_ATTRIBUTE_12
...
- Directory: `gnu`
- File list: gnu/error.c, gnu/hash.c
...
- Definition location: [gnu/error.c:206-288]
- Source file: `gnu/error.c`
- Observed declaration: `static void _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD (3, 0) _GL_ARG_NONNULL ((3)) error_tail (int status, int errnum, const char *message, va_list args);`
- Approximate function body length: 83 lines
### `_GL_ATTRIBUTE_CONST`
- Definition location: [gnu/hash.c:398-412]
- Source file: `gnu/hash.c`
- Observed declaration: `static bool _GL_ATTRIBUTE_CONST is_prime (size_t candidate);`
- Approximate function body length: 15 lines
### `_GL_ATTRIBUTE_CONST`
- Definition location: [gnu/hash.c:417-431]
- Source file: `gnu/hash.c`
- Observed declaration: `static size_t _GL_ATTRIBUTE_CONST next_prime (size_t candidate);`
- Approximate function body length: 15 lines

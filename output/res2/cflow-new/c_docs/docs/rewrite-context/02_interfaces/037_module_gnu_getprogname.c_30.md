# Interface Facts: module_gnu_getprogname.c_30
...
- Struct definitions observed: 129
...
## Functions
### `getprogname`
- Definition location: [gnu/getprogname.c:63-305]
- Source file: `gnu/getprogname.c`
- Observed declaration: `char const * getprogname (void);`
- Approximate function body length: 243 lines
...
- Observed declaration prefix: `struct`
### `anonymous`
- Definition location: [gnu/getprogname.c:107]
- Source file: `gnu/getprogname.c`
- Observed declaration prefix: `truct procentry64`
### `anonymous`
- Definition location: [gnu/getprogname.c:122]
- Source file: `gnu/getprogname.c`
- Observed declaration prefix: `truct pst_status`
### `anonymous`
...
- `procentry64`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.
- `pst_status`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.
- `size`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

# Interface Facts: module_gnu_calloc.c_22
...
## Functions
### `rpl_calloc`
- Definition location: [gnu/calloc.c:37-57]
- Source file: `gnu/calloc.c`
- Observed declaration: `void * rpl_calloc (size_t n, size_t s);`

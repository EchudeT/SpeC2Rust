# Interface Facts: module_src_parseopt_position_06
...
## Functions
### `position_init`
- Definition location: [src/parseopt/wordwrap.c:46-50]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `static inline void position_init (struct position *pos, unsigned n);`
- Approximate function body length: 5 lines
### `position_incr`
- Definition location: [src/parseopt/wordwrap.c:52-57]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `static inline void position_incr (struct position *pos, int nbytes);`
- Approximate function body length: 6 lines
### `position_add`
- Definition location: [src/parseopt/wordwrap.c:59-64]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `static inline void position_add (struct position *a, struct position *b);`
- Approximate function body length: 6 lines
### `position_eq`
- Definition location: [src/parseopt/wordwrap.c:66-70]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `static inline int position_eq (struct position *a, struct position *b);`
- Approximate function body length: 5 lines
### `wordwrap_last_ws`
- Definition location: [src/parseopt/wordwrap.c:326-356]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `static struct position wordwrap_last_ws (WORDWRAP_FILE wf, size_t size, struct position *last_ws);`
- Approximate function body length: 31 lines
### `flush_line`
- Definition location: [src/parseopt/wordwrap.c:362-431]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `static int flush_line (WORDWRAP_FILE wf, size_t size);`
- Approximate function body length: 70 lines
...
- `position`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

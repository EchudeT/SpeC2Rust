# Interface Facts: module_gnu_stat_05
...
- Directory: `gnu`
- File list: gnu/stat.c, gnu/xmalloc.c
...
- Struct definitions observed: 135
...
## Functions
### `rpl_stat`
- Definition location: [gnu/stat.c:111-440]
- Source file: `gnu/stat.c`
- Observed declaration: `int rpl_stat (char const *name, struct stat *buf);`
- Approximate function body length: 330 lines
### `_GL_ATTRIBUTE_PURE`
- Definition location: [gnu/xmalloc.c:34-40]
- Source file: `gnu/xmalloc.c`
- Observed declaration: `static void * _GL_ATTRIBUTE_PURE nonnull (void *p);`

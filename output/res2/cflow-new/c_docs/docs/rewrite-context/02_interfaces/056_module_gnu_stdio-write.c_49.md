# Interface Facts: module_gnu_stdio-write.c_49
...
## Functions
### `printf`
- Definition location: [gnu/stdio-write.c:126-137]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `int printf (const char *format, ...);`
- Approximate function body length: 12 lines
### `fprintf`
- Definition location: [gnu/stdio-write.c:141-152]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `int fprintf (FILE *stream, const char *format, ...);`
- Approximate function body length: 12 lines
### `vprintf`
- Definition location: [gnu/stdio-write.c:156-160]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `int vprintf (const char *format, va_list args);`
- Approximate function body length: 5 lines
### `vfprintf`
- Definition location: [gnu/stdio-write.c:164-169]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `int vfprintf (FILE *stream, const char *format, va_list args) #undef vfprintf;`
- Approximate function body length: 6 lines
### `putchar`
- Definition location: [gnu/stdio-write.c:172-176]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `int putchar (int c);`
- Approximate function body length: 5 lines
### `fputc`
- Definition location: [gnu/stdio-write.c:178-183]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `int fputc (int c, FILE *stream) #undef fputc;`
- Approximate function body length: 6 lines
### `fputs`
- Definition location: [gnu/stdio-write.c:185-190]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `int fputs (const char *string, FILE *stream) #undef fputs;`
- Approximate function body length: 6 lines
### `puts`
- Definition location: [gnu/stdio-write.c:192-198]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `int puts (const char *string) #undef puts;`
- Approximate function body length: 7 lines
### `fwrite`
- Definition location: [gnu/stdio-write.c:200-205]
- Source file: `gnu/stdio-write.c`
- Observed declaration: `size_t fwrite (const void *ptr, size_t s, size_t n, FILE *stream) #undef fwrite;`
- Approximate function body length: 6 lines

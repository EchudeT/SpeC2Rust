# Interface Facts: module_gnu_vasnprintf.c_53
...
## Functions
### `decode_long_double`
- Definition location: [gnu/vasnprintf.c:1006-1084]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static void * decode_long_double (long double x, int *ep, mpn_t *mp);`
- Approximate function body length: 79 lines
### `decode_double`
- Definition location: [gnu/vasnprintf.c:1094-1169]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static void * decode_double (double x, int *ep, mpn_t *mp);`
- Approximate function body length: 76 lines
### `floorlog10l`
- Definition location: [gnu/vasnprintf.c:1438-1520]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static int floorlog10l (long double x);`
- Approximate function body length: 83 lines
### `floorlog10`
- Definition location: [gnu/vasnprintf.c:1529-1611]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static int floorlog10 (double x);`
- Approximate function body length: 83 lines
### `is_borderline`
- Definition location: [gnu/vasnprintf.c:1617-1627]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static int is_borderline (const char *digits, size_t precision);`

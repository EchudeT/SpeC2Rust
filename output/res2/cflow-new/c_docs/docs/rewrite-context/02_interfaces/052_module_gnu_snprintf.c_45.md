# Interface Facts: module_gnu_snprintf.c_45
...
## Functions
### `snprintf`
- Definition location: [gnu/snprintf.c:38-73]
- Source file: `gnu/snprintf.c`
- Observed declaration: `int snprintf (char *str, size_t size, const char *format, ...);`

# Interface Facts: module_src_c.c_22
...
## Functions
### `pp_finalize`
- Definition location: [src/c.c:2873-2888]
- Source file: `src/c.c`
- Observed declaration: `void pp_finalize();`
- Approximate function body length: 16 lines
### `pp_open`
- Definition location: [src/c.c:2890-2915]
- Source file: `src/c.c`
- Observed declaration: `FILE * pp_open(const char *name);`
- Approximate function body length: 26 lines
### `pp_close`
- Definition location: [src/c.c:2917-2921]
- Source file: `src/c.c`
- Observed declaration: `void pp_close(FILE *fp);`
- Approximate function body length: 5 lines
### `yywrap`
- Definition location: [src/c.c:2925-2940]
- Source file: `src/c.c`
- Observed declaration: `int yywrap();`
- Approximate function body length: 16 lines
### `get_token`
- Definition location: [src/c.c:2944-2958]
- Source file: `src/c.c`
- Observed declaration: `int get_token();`
- Approximate function body length: 15 lines
### `source`
- Definition location: [src/c.c:2960-2985]
- Source file: `src/c.c`
- Observed declaration: `int source(char *name);`
- Approximate function body length: 26 lines
### `getnum`
- Definition location: [src/c.c:2987-3005]
- Source file: `src/c.c`
- Observed declaration: `static int getnum(unsigned base, int count);`
- Approximate function body length: 19 lines
### `backslash`
- Definition location: [src/c.c:3007-3023]
- Source file: `src/c.c`
- Observed declaration: `int backslash();`
- Approximate function body length: 17 lines
### `update_loc`
- Definition location: [src/c.c:3025-3049]
- Source file: `src/c.c`
- Observed declaration: `void update_loc();`

# Interface Facts: module_src_yy_flex_16
...
## Functions
### `yy_flex_strncpy`
- Definition location: [src/c.c:2688-2694]
- Source file: `src/c.c`
- Observed declaration: `static void yy_flex_strncpy (char* s1, const char * s2, int n );`
- Approximate function body length: 7 lines
### `yy_flex_strlen`
- Definition location: [src/c.c:2698-2705]
- Source file: `src/c.c`
- Observed declaration: `static int yy_flex_strlen (const char * s );`

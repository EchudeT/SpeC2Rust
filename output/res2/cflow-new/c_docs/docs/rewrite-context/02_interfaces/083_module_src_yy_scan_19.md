# Interface Facts: module_src_yy_scan_19
...
## Functions
### `yy_scan_string`
- Definition location: [src/c.c:2456-2460]
- Source file: `src/c.c`
- Observed declaration: `YY_BUFFER_STATE yy_scan_string (const char * yystr );`
- Approximate function body length: 5 lines
### `yy_scan_bytes`
- Definition location: [src/c.c:2471-2499]
- Source file: `src/c.c`
- Observed declaration: `YY_BUFFER_STATE yy_scan_bytes (const char * yybytes, int _yybytes_len );`

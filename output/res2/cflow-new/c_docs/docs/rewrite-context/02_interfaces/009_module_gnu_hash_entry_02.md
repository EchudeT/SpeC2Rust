# Interface Facts: module_gnu_hash_entry_02
...
- Definition location: [gnu/hash.c:935-1018]
- Source file: `gnu/hash.c`
- Observed declaration: `int hash_insert_if_absent (Hash_table *table, void const *entry, void const **matched_ent);`
- Approximate function body length: 84 lines
### `hash_remove`
- Definition location: [gnu/hash.c:1030-1088]
- Source file: `gnu/hash.c`
- Observed declaration: `void * hash_remove (Hash_table *table, const void *entry);`
- Approximate function body length: 59 lines
### `hash_print`
- Definition location: [gnu/hash.c:1100-1120]
- Source file: `gnu/hash.c`
- Observed declaration: `void hash_print (const Hash_table *table);`

# Interface Facts: module_gnu_error.c_26
...
## Functions
### `is_open`
- Definition location: [gnu/error.c:132-147]
- Source file: `gnu/error.c`
- Observed declaration: `static int is_open (int fd);`
- Approximate function body length: 16 lines
### `flush_stdout`
- Definition location: [gnu/error.c:150-173]
- Source file: `gnu/error.c`
- Observed declaration: `static void flush_stdout (void);`
- Approximate function body length: 24 lines
### `print_errno_message`
- Definition location: [gnu/error.c:175-204]
- Source file: `gnu/error.c`
- Observed declaration: `static void print_errno_message (int errnum);`
- Approximate function body length: 30 lines
### `error`
- Definition location: [gnu/error.c:295-333]
- Source file: `gnu/error.c`
- Observed declaration: `void error (int status, int errnum, const char *message, ...);`
- Approximate function body length: 39 lines
### `error_at_line`
- Definition location: [gnu/error.c:339-404]
- Source file: `gnu/error.c`
- Observed declaration: `void error_at_line (int status, int errnum, const char *file_name, unsigned int line_number, const char *message, ...);`

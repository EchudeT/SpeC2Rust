# Interface Facts: module_src_parseopt_help_context_05
...
## Functions
### `sort_options`
- Definition location: [src/parseopt/help.c:692-710]
- Source file: `src/parseopt/help.c`
- Observed declaration: `static void sort_options (struct help_context *ctx);`
- Approximate function body length: 19 lines
### `print_option_group`
- Definition location: [src/parseopt/help.c:712-723]
- Source file: `src/parseopt/help.c`
- Observed declaration: `static void print_option_group (WORDWRAP_FILE wf, struct help_context *ctx);`

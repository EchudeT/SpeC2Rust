# Interface Facts: module_gnu_hash_get_13
...
## Functions
### `hash_get_n_buckets`
- Definition location: [gnu/hash.c:144-148]
- Source file: `gnu/hash.c`
- Observed declaration: `size_t hash_get_n_buckets (const Hash_table *table);`
- Approximate function body length: 5 lines
### `hash_get_n_buckets_used`
- Definition location: [gnu/hash.c:150-154]
- Source file: `gnu/hash.c`
- Observed declaration: `size_t hash_get_n_buckets_used (const Hash_table *table);`
- Approximate function body length: 5 lines
### `hash_get_n_entries`
- Definition location: [gnu/hash.c:156-160]
- Source file: `gnu/hash.c`
- Observed declaration: `size_t hash_get_n_entries (const Hash_table *table);`
- Approximate function body length: 5 lines

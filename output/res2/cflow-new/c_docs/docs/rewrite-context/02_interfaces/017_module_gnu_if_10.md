# Interface Facts: module_gnu_if_10
...
## Functions
### `if`
- Definition location: [gnu/vasnprintf.c:2914-3366]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `else if (dp->conversion == 's' # if WIDE_CHAR_VERSION && a.arg[dp->arg_index].type != TYPE_WIDE_STRING # else && a.arg[dp->arg_index].type == TYPE_WIDE_STRING # endif );`
- Approximate function body length: 453 lines
### `if`
- Definition location: [gnu/vasnprintf.c:3369-3557]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `else if (dp->conversion == 'c' && a.arg[dp->arg_index].type == TYPE_WIDE_CHAR);`
- Approximate function body length: 189 lines

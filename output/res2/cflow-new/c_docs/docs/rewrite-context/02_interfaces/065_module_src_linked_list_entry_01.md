# Interface Facts: module_src_linked_list_entry_01
...
- Directory: `src`
- File list: src/dot.c, src/linked-list.c, src/main.c, src/output.c
...
- Struct definitions observed: 214
...
## Functions
### `dot_print_symbol`
- Definition location: [src/dot.c:38-58]
- Source file: `src/dot.c`
- Observed declaration: `static void dot_print_symbol(FILE *fp, int line, struct output_symbol *s);`
- Approximate function body length: 21 lines
### `linked_list_append`
- Definition location: [src/linked-list.c:41-56]
- Source file: `src/linked-list.c`
- Observed declaration: `void linked_list_append(struct linked_list **plist, void *data);`
- Approximate function body length: 16 lines
### `linked_list_prepend`
- Definition location: [src/linked-list.c:59-74]
- Source file: `src/linked-list.c`
- Observed declaration: `void linked_list_prepend(struct linked_list **plist, void *data);`
- Approximate function body length: 16 lines
### `linked_list_destroy`
- Definition location: [src/linked-list.c:77-94]
- Source file: `src/linked-list.c`
- Observed declaration: `void linked_list_destroy(struct linked_list **plist);`
- Approximate function body length: 18 lines
### `linked_list_unlink`
- Definition location: [src/linked-list.c:96-113]
- Source file: `src/linked-list.c`
- Observed declaration: `void linked_list_unlink(struct linked_list *list, struct linked_list_entry *ent);`
- Approximate function body length: 18 lines
### `linked_list_iterate`
- Definition location: [src/linked-list.c:115-135]
- Source file: `src/linked-list.c`
- Observed declaration: `void linked_list_iterate(struct linked_list **plist, int (*itr) (void *, void *), void *data);`
- Approximate function body length: 21 lines
### `data_in_list`
- Definition location: [src/linked-list.c:137-146]
- Source file: `src/linked-list.c`
- Observed declaration: `int data_in_list(void *data, struct linked_list *list);`
- Approximate function body length: 10 lines
### `linked_list_size`
- Definition location: [src/linked-list.c:148-158]
- Source file: `src/linked-list.c`
- Observed declaration: `size_t linked_list_size(struct linked_list *list);`
- Approximate function body length: 11 lines
### `optfile_register`
- Definition location: [src/main.c:1078-1099]
- Source file: `src/main.c`
- Observed declaration: `static int optfile_register(dev_t dev, ino_t ino);`
- Approximate function body length: 22 lines
### `print_refs`
- Definition location: [src/output.c:208-221]
- Source file: `src/output.c`
- Observed declaration: `void print_refs(char *name, struct linked_list *reflist);`
- Approximate function body length: 14 lines
### `is_printable`
- Definition location: [src/output.c:282-286]
- Source file: `src/output.c`
- Observed declaration: `static int is_printable(struct linked_list_entry *p);`
- Approximate function body length: 5 lines
### `is_last`
- Definition location: [src/output.c:288-295]
- Source file: `src/output.c`
- Observed declaration: `static int is_last(struct linked_list_entry *p);`
- Approximate function body length: 8 lines
### `direct_tree`
- Definition location: [src/output.c:299-320]
- Source file: `src/output.c`
- Observed declaration: `static void direct_tree(int lev, int last, Symbol *sym);`
- Approximate function body length: 22 lines
### `inverted_tree`
- Definition location: [src/output.c:324-344]
- Source file: `src/output.c`
- Observed declaration: `static void inverted_tree(int lev, int last, Symbol *sym);`
- Approximate function body length: 21 lines
### `tree_output`
- Definition location: [src/output.c:346-422]
- Source file: `src/output.c`
- Observed declaration: `static void tree_output();`
...
### `anonymous`
- Definition location: [src/dot.c:39]
- Source file: `src/dot.c`
- Observed declaration prefix: `struct output_symbol`
### `anonymous`
- Definition location: [src/dot.c:41]
- Source file: `src/dot.c`
- Observed declaration prefix: `struct linked_list`
### `anonymous`
- Definition location: [src/dot.c:42]
- Source file: `src/dot.c`
- Observed declaration prefix: `struct linked_list_entry`
### `anonymous`
...
- `linked_list_entry`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.
- `optfileid`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.
- `output_symbol`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

...
- Observed focus: organized around functions with the `is_infinite_or_zero` prefix
...
- `is_infinite_or_zero` [gnu/vasnprintf.c:392-396]: `static int is_infinite_or_zero (double x);`
- `is_infinite_or_zerol` [gnu/vasnprintf.c:403-407]: `static int is_infinite_or_zerol (long double x);`

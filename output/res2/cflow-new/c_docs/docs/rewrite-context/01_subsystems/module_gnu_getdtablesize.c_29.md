...
- Observed focus: organized around functions with the `setmaxstdio_nothrow` prefix
...
- `_setmaxstdio_nothrow` [gnu/getdtablesize.c:34-42]: `static int _setmaxstdio_nothrow (int newmax);`

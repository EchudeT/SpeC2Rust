...
- Observed focus: organized around functions with the `save_stack` prefix
...
- `save_stack` [src/parser.c:411-416]: `void save_stack();`
- `save_stack_is_empty` [src/parser.c:424-428]: `int save_stack_is_empty();`

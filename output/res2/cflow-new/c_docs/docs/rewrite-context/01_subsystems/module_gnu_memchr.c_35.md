...
- Observed focus: organized around functions with the `memchr` prefix
- Module category: `module_cluster`
- Directory scope: `gnu`

## 2. Inputs and Outputs
- At this stage, do not speculate about runtime I/O; define interface boundaries by the observed function signatures and source files.
- File input boundary: gnu/memchr.c
- Function count: 1

## 3. Core Interface List
- `__memchr` [gnu/memchr.c:60-171]: `void * __memchr (void const *s, int c_in, size_t n);`

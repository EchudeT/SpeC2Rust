...
- Observed focus: organized around functions with the `set_program_name` prefix
- Module category: `module_cluster`
- Directory scope: `gnu`

## 2. Inputs and Outputs
- At this stage, do not speculate about runtime I/O; define interface boundaries by the observed function signatures and source files.
- File input boundary: gnu/progname.c
- Function count: 1

## 3. Core Interface List
- `set_program_name` [gnu/progname.c:40-94]: `void set_program_name (const char *argv0);`

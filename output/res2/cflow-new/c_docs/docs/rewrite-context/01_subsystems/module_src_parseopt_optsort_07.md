...
- Observed focus: organized around source files related to `help`
- Module category: `module_cluster`
- Directory scope: `src/parseopt`

## 2. Inputs and Outputs
- At this stage, do not speculate about runtime I/O; define interface boundaries by the observed function signatures and source files.
- File input boundary: src/parseopt/help.c
- Function count: 2

## 3. Core Interface List
- `optsort` [src/parseopt/help.c:364-395]: `static int optsort (struct optsort *ops, int n);`
- `sortnames` [src/parseopt/help.c:623-640]: `static void sortnames (struct optsort *ops, int i, int j);`

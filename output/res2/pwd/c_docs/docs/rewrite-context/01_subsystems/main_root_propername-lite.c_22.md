...
- Observed focus: organized around functions with the `proper_name_lite` prefix
- Module category: `main_cluster`
- Directory scope: `root`

## 2. Inputs and Outputs
- At this stage, do not speculate about runtime I/O; define interface boundaries by the observed function signatures and source files.
- File input boundary: propername-lite.c
- Function count: 1

## 3. Core Interface List
- `proper_name_lite` [propername-lite.c:29-36]: `char const * proper_name_lite (char const *name_ascii, char const *name_utf8);`

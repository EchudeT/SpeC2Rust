# Interface Facts: main_root_pwd.c_23
...
## Functions
### `usage`
- Definition location: [pwd.c:48-75]
- Source file: `pwd.c`
- Observed declaration: `void usage (int status);`
- Approximate function body length: 28 lines
### `nth_parent`
- Definition location: [pwd.c:126-139]
- Source file: `pwd.c`
- Observed declaration: `static char * nth_parent (size_t n);`

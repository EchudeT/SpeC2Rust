# Interface Facts: main_root_xmalloc.c_29
...
## Functions
### `xcalloc`
- Definition location: [xmalloc.c:295-299]
- Source file: `xmalloc.c`
- Observed declaration: `void * xcalloc (size_t n, size_t s);`
- Approximate function body length: 5 lines
### `xicalloc`
- Definition location: [xmalloc.c:301-305]
- Source file: `xmalloc.c`
- Observed declaration: `void * xicalloc (idx_t n, idx_t s);`
- Approximate function body length: 5 lines
### `xmemdup`
- Definition location: [xmalloc.c:311-315]
- Source file: `xmalloc.c`
- Observed declaration: `void * xmemdup (void const *p, size_t s);`
- Approximate function body length: 5 lines
### `ximemdup`
- Definition location: [xmalloc.c:317-321]
- Source file: `xmalloc.c`
- Observed declaration: `void * ximemdup (void const *p, idx_t s);`
- Approximate function body length: 5 lines
### `ximemdup0`
- Definition location: [xmalloc.c:326-332]
- Source file: `xmalloc.c`
- Observed declaration: `char * ximemdup0 (void const *p, idx_t s);`
- Approximate function body length: 7 lines
### `xstrdup`
- Definition location: [xmalloc.c:336-340]
- Source file: `xmalloc.c`
- Observed declaration: `char * xstrdup (char const *string);`
- Approximate function body length: 5 lines

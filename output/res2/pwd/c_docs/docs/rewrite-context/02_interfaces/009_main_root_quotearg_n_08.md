# Interface Facts: main_root_quotearg_n_08
...
## Functions
### `quotearg_n`
- Definition location: [quotearg.c:925-929]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_n (int n, char const *arg);`
- Approximate function body length: 5 lines
### `quotearg_n_mem`
- Definition location: [quotearg.c:931-935]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_n_mem (int n, char const *arg, size_t argsize);`
- Approximate function body length: 5 lines
### `quotearg_n_custom`
- Definition location: [quotearg.c:1012-1018]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_n_custom (int n, char const *left_quote, char const *right_quote, char const *arg);`

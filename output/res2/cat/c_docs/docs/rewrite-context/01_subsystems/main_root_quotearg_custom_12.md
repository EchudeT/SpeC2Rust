...
- Observed focus: organized around functions with the `quotearg_custom` prefix
...
- `quotearg_custom` [quotearg.c:1030-1035]: `har * quotearg_custom (char const *left_quote, char const *right_quote, char const *arg);`
- `quotearg_custom_mem` [quotearg.c:1037-1043]: `har * quotearg_custom_mem (char const *left_quote, char const *right_quote, char const *arg, size_t argsize);`

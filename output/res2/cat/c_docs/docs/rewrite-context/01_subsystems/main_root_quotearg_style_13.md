...
- Observed focus: organized around functions with the `quotearg_style` prefix
...
- `quotearg_style` [quotearg.c:964-968]: `har * quotearg_style (enum quoting_style s, char const *arg);`
- `quotearg_style_mem` [quotearg.c:970-974]: `har * quotearg_style_mem (enum quoting_style s, char const *arg, size_t argsize);`

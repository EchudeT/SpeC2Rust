...
- Observed focus: organized around functions with the `emit_bug_reporting_address` prefix
...
- `emit_bug_reporting_address` [version-etc.c:241-262]: `void emit_bug_reporting_address (void);`

# Interface Facts: main_root_quotearg.c_32
...
## Functions
### `gettext_quote`
- Definition location: [quotearg.c:198-232]
- Source file: `quotearg.c`
- Observed declaration: `static char const * gettext_quote (char const *msgid, enum quoting_style s);`
- Approximate function body length: 35 lines
### `quotearg_buffer_restyled`
- Definition location: [quotearg.c:247-768]
- Source file: `quotearg.c`
- Observed declaration: `static size_t quotearg_buffer_restyled (char *buffer, size_t buffersize, char const *arg, size_t argsize, enum quoting_style quoting_style, int flags, unsigned int const *quote_these_too, char const *left_quote, char...`
- Approximate function body length: 522 lines
### `quotearg_free`
- Definition location: [quotearg.c:842-861]
- Source file: `quotearg.c`
- Observed declaration: `oid quotearg_free (void);`
- Approximate function body length: 20 lines
### `quotearg`
- Definition location: [quotearg.c:937-941]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg (char const *arg);`
- Approximate function body length: 5 lines
### `quotearg_mem`
- Definition location: [quotearg.c:943-947]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_mem (char const *arg, size_t argsize);`
- Approximate function body length: 5 lines
### `quotearg_char`
- Definition location: [quotearg.c:985-989]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_char (char const *arg, char ch);`
- Approximate function body length: 5 lines
### `quote_mem`
- Definition location: [quotearg.c:1061-1065]
- Source file: `quotearg.c`
- Observed declaration: `har const * quote_mem (char const *arg, size_t argsize);`
- Approximate function body length: 5 lines
### `quote`
- Definition location: [quotearg.c:1073-1077]
- Source file: `quotearg.c`
- Observed declaration: `har const * quote (char const *arg);`
- Approximate function body length: 5 lines

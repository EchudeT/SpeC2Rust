# Interface Facts: main_root_fadvise.c_22
...
- Directory: `root`
- File list: fadvise.c
- Candidate header files: include/config.h, include/fadvise.h, include/fcntl.h, include/ignore-value.h, include/stdio.h
...
## Functions
### `fdadvise`
- Definition location: [fadvise.c:24-30]
- Source file: `fadvise.c`
- Observed declaration: `void fdadvise (int fd, off_t offset, off_t len, fadvice_t advice);`
- Approximate function body length: 7 lines
### `fadvise`
- Definition location: [fadvise.c:32-37]
- Source file: `fadvise.c`
- Observed declaration: `void fadvise (FILE *fp, fadvice_t advice);`

# Interface Facts: main_root_quoting_options_02
...
- Definition location: [quotearg.c:1020-1028]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_n_custom_mem (int n, char const *left_quote, char const *right_quote, char const *arg, size_t argsize);`

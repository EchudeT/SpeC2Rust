# Interface Facts: main_root_xalignalloc.c_34
...
- Directory: `root`
- File list: xalignalloc.c
- Candidate header files: include/alignalloc.h, include/config.h, include/xalloc.h
...
## Functions
### `xalignalloc`
- Definition location: [xalignalloc.c:26-33]
- Source file: `xalignalloc.c`
- Observed declaration: `void * xalignalloc (idx_t alignment, idx_t size);`

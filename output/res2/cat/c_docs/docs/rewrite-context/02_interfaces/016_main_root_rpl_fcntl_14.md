# Interface Facts: main_root_rpl_fcntl_14
...
- Directory: `root`
- File list: fcntl.c
- Candidate header files: include/config.h, include/fcntl.h, include/limits.h, include/stdlib.h, include/unistd.h
...
## Functions
### `rpl_fcntl_DUPFD`
- Definition location: [fcntl.c:446-485]
- Source file: `fcntl.c`
- Observed declaration: `static int rpl_fcntl_DUPFD (int fd, int target);`
- Approximate function body length: 40 lines
### `rpl_fcntl_DUPFD_CLOEXEC`
- Definition location: [fcntl.c:487-544]
- Source file: `fcntl.c`
- Observed declaration: `static int rpl_fcntl_DUPFD_CLOEXEC (int fd, int target);`

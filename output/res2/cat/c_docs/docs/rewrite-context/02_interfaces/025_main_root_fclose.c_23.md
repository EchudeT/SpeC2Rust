# Interface Facts: main_root_fclose.c_23
...
- Directory: `root`
- File list: fclose.c
- Candidate header files: include/config.h, include/freading.h, include/stdio.h, include/unistd.h
...
## Functions
### `fclose_nothrow`
- Definition location: [fclose.c:33-41]
- Source file: `fclose.c`
- Observed declaration: `static int fclose_nothrow (FILE *fp);`
- Approximate function body length: 9 lines
### `rpl_fclose`
- Definition location: [fclose.c:57-112]
- Source file: `fclose.c`
- Observed declaration: `int rpl_fclose (FILE *fp);`

# Interface Facts: main_root_fflush.c_18
...
- Definition location: [fflush.c:80-86]
- Source file: `fflush.c`
- Observed declaration: `static int disable_seek_optimization (FILE *fp);`
- Approximate function body length: 7 lines
### `restore_seek_optimization`
- Definition location: [fflush.c:88-92]
- Source file: `fflush.c`
- Observed declaration: `static void restore_seek_optimization (FILE *fp, int saved_flags);`
- Approximate function body length: 5 lines
### `update_fpos_cache`
- Definition location: [fflush.c:96-120]
- Source file: `fflush.c`
- Observed declaration: `static void update_fpos_cache (_GL_ATTRIBUTE_MAYBE_UNUSED FILE *fp, _GL_ATTRIBUTE_MAYBE_UNUSED off_t pos);`
- Approximate function body length: 25 lines
### `rpl_fflush`
- Definition location: [fflush.c:126-233]
- Source file: `fflush.c`
- Observed declaration: `int rpl_fflush (FILE *stream);`
- Approximate function body length: 108 lines
...
- `containing`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

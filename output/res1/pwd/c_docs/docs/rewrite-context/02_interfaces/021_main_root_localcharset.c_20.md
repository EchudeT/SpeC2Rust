# Interface Facts: main_root_localcharset.c_20
...
- Directory: `root`
- File list: localcharset.c
- Candidate header files: include/config.h, include/localcharset.h, include/stddef.h, include/stdio.h, include/stdlib.h, include/string.h
- Exported functions observed: 1
- Struct definitions observed: 22
...
## Functions
### `locale_charset`
- Definition location: [localcharset.c:830-1159]
- Source file: `localcharset.c`
- Observed declaration: `const char * locale_charset (void);`
- Approximate function body length: 330 lines
...
- Observed declaration prefix: `struct random_data`
### `anonymous`
- Definition location: [localcharset.c:86-90]
- Source file: `localcharset.c`
- Observed declaration prefix: `struct table_entry`
### `anonymous`
- Definition location: [localcharset.c:93]
- Source file: `localcharset.c`
- Observed declaration prefix: `struct table_entry`
### `anonymous`
- Definition location: [localcharset.c:577-581]
- Source file: `localcharset.c`
- Observed declaration prefix: `struct table_entry`
### `anonymous`
- Definition location: [localcharset.c:584]
- Source file: `localcharset.c`
- Observed declaration prefix: `struct table_entry`
### `anonymous`
- Definition location: [localcharset.c:1030]
- Source file: `localcharset.c`
- Observed declaration prefix: `struct table_entry`
### `anonymous`
- Definition location: [localcharset.c:1032]
- Source file: `localcharset.c`
- Observed declaration prefix: `struct table_entry`
### `anonymous`
- Definition location: [localcharset.c:1104]
- Source file: `localcharset.c`
- Observed declaration prefix: `struct table_entry`
### `anonymous`
- Definition location: [localcharset.c:1106]
- Source file: `localcharset.c`
- Observed declaration prefix: `struct table_entry`

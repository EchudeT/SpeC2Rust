# Interface Facts: main_root_xgetcwd.c_27
...
- Directory: `root`
- File list: xgetcwd.c
- Candidate header files: include/config.h, include/unistd.h, include/xalloc.h, include/xgetcwd.h
...
## Functions
### `xgetcwd`
- Definition location: [xgetcwd.c:34-41]
- Source file: `xgetcwd.c`
- Observed declaration: `char * xgetcwd (void);`

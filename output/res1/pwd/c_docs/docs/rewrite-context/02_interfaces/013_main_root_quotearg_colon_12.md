# Interface Facts: main_root_quotearg_colon_12
...
## Functions
### `quotearg_colon`
- Definition location: [quotearg.c:991-995]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_colon (char const *arg);`
- Approximate function body length: 5 lines
### `quotearg_colon_mem`
- Definition location: [quotearg.c:997-1001]
- Source file: `quotearg.c`
- Observed declaration: `har * quotearg_colon_mem (char const *arg, size_t argsize);`
- Approximate function body length: 5 lines

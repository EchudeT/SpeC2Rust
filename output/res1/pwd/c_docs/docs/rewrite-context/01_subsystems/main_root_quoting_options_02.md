...
- Observed focus: organized around functions with the `quotearg_n_custom_mem` prefix
...
- `quotearg_n_custom_mem` [quotearg.c:1020-1028]: `har * quotearg_n_custom_mem (int n, char const *left_quote, char const *right_quote, char const *arg, size_t argsize);`

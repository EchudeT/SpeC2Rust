# Interface Facts: module_gnu_scale10_round_14
...
- Definition location: [gnu/vasnprintf.c:1178-1389]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static char * scale10_round_decimal_decoded (int e, mpn_t m, void *memory, int n);`
- Approximate function body length: 212 lines
### `scale10_round_decimal_long_double`
- Definition location: [gnu/vasnprintf.c:1398-1408]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static char * scale10_round_decimal_long_double (long double x, int n);`
- Approximate function body length: 11 lines
### `scale10_round_decimal_double`
- Definition location: [gnu/vasnprintf.c:1419-1429]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `static char * scale10_round_decimal_double (double x, int n);`
- Approximate function body length: 11 lines

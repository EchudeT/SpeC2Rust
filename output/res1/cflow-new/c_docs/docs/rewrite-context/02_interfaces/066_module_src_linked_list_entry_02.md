# Interface Facts: module_src_linked_list_entry_02
...
## Functions
### `collect_functions`
- Definition location: [src/symbol.c:363-382]
- Source file: `src/symbol.c`
- Observed declaration: `size_t collect_functions(Symbol ***return_sym);`
- Approximate function body length: 20 lines
### `move_parms`
- Definition location: [src/symbol.c:414-428]
- Source file: `src/symbol.c`
- Observed declaration: `void move_parms(int level);`
- Approximate function body length: 15 lines
### `first_starter`
- Definition location: [src/symbol.c:453-467]
- Source file: `src/symbol.c`
- Observed declaration: `Symbol * first_starter(void *itr);`
- Approximate function body length: 15 lines
### `next_starter`
- Definition location: [src/symbol.c:469-487]
- Source file: `src/symbol.c`
- Observed declaration: `Symbol * next_starter(void *itr);`
- Approximate function body length: 19 lines
### `mark_callers`
- Definition location: [src/symbol.c:499-512]
- Source file: `src/symbol.c`
- Observed declaration: `static void mark_callers(Symbol *sym);`
- Approximate function body length: 14 lines
### `eliminate_non_targets`
- Definition location: [src/symbol.c:515-532]
- Source file: `src/symbol.c`
- Observed declaration: `void eliminate_non_targets(void);`

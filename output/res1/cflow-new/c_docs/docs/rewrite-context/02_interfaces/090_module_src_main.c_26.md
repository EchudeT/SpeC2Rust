# Interface Facts: module_src_main.c_26
...
- Exported functions observed: 12
...
## Functions
### `CHAR_TO_SM`
- Definition location: [src/main.c:75-86]
- Source file: `src/main.c`
- Observed declaration: `static inline int CHAR_TO_SM(int c);`
- Approximate function body length: 12 lines
### `find_option_type`
- Definition location: [src/main.c:106-119]
- Source file: `src/main.c`
- Observed declaration: `static int find_option_type(struct option_type *optype, const char *str, int len);`
- Approximate function body length: 14 lines
### `symbol_override`
- Definition location: [src/main.c:138-190]
- Source file: `src/main.c`
- Observed declaration: `static void symbol_override(const char *str);`
- Approximate function body length: 53 lines
### `number`
- Definition location: [src/main.c:197-217]
- Source file: `src/main.c`
- Observed declaration: `static int number(const char **str_ptr, int base, int count);`
- Approximate function body length: 21 lines
### `parse_level_string`
- Definition location: [src/main.c:250-322]
- Source file: `src/main.c`
- Observed declaration: `static void parse_level_string(const char *str, char **return_ptr);`
- Approximate function body length: 73 lines
### `tildexpand`
- Definition location: [src/main.c:1101-1133]
- Source file: `src/main.c`
- Observed declaration: `static char * tildexpand(char const *str);`
- Approximate function body length: 33 lines
### `parse_rc`
- Definition location: [src/main.c:1289-1317]
- Source file: `src/main.c`
- Observed declaration: `int parse_rc(void);`
- Approximate function body length: 29 lines
### `globals_only`
- Definition location: [src/main.c:1340-1344]
- Source file: `src/main.c`
- Observed declaration: `int globals_only();`
- Approximate function body length: 5 lines
### `include_symbol`
- Definition location: [src/main.c:1346-1378]
- Source file: `src/main.c`
- Observed declaration: `int include_symbol(Symbol *sym);`
- Approximate function body length: 33 lines
### `xalloc_die`
- Definition location: [src/main.c:1380-1385]
- Source file: `src/main.c`
- Observed declaration: `void xalloc_die(void);`
- Approximate function body length: 6 lines
### `init`
- Definition location: [src/main.c:1387-1401]
- Source file: `src/main.c`
- Observed declaration: `void init();`
- Approximate function body length: 15 lines
### `main`
- Definition location: [src/main.c:1403-1470]
- Source file: `src/main.c`
...
- `option_type`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

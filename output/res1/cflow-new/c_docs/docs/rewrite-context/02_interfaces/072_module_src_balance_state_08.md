# Interface Facts: module_src_balance_state_08
...
## Functions
### `push_balance_state`
- Definition location: [src/parser.c:481-489]
- Source file: `src/parser.c`
- Observed declaration: `static void push_balance_state(struct balance_state **ptos, int idx, int level);`
- Approximate function body length: 9 lines
### `pop_balance_state`
- Definition location: [src/parser.c:491-499]
- Source file: `src/parser.c`
- Observed declaration: `static void pop_balance_state(struct balance_state **ptos, int *idx, int *level);`
- Approximate function body length: 9 lines
### `free_balance_stack`
- Definition location: [src/parser.c:501-507]
- Source file: `src/parser.c`
- Observed declaration: `static void free_balance_stack(struct balance_state **ptos);`
- Approximate function body length: 7 lines
### `find_closing_paren`
- Definition location: [src/parser.c:509-554]
- Source file: `src/parser.c`
- Observed declaration: `static int find_closing_paren(int open_tok, int level);`

# Interface Facts: module_src_gnu.c_25
...
## Functions
### `gnu_output_handler`
- Definition location: [src/gnu.c:61-88]
- Source file: `src/gnu.c`
- Observed declaration: `int gnu_output_handler(cflow_output_command cmd, FILE *outfile, int line, void *data, void *handler_data);`

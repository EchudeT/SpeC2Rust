# Interface Facts: module_src_collect_data_10
...
## Functions
### `collect_list_entry`
- Definition location: [src/symbol.c:329-341]
- Source file: `src/symbol.c`
- Observed declaration: `static int collect_list_entry(void *item, void *proc_data);`
- Approximate function body length: 13 lines
### `collect_symbols`
- Definition location: [src/symbol.c:343-361]
- Source file: `src/symbol.c`
- Observed declaration: `size_t collect_symbols(Symbol ***return_sym, int (*sel)(Symbol *p), size_t reserved_slots);`

# Interface Facts: module_gnu_realloc.c_43
...
## Functions
### `rpl_realloc`
- Definition location: [gnu/realloc.c:39-65]
- Source file: `gnu/realloc.c`
- Observed declaration: `void * rpl_realloc (void *p, size_t n);`

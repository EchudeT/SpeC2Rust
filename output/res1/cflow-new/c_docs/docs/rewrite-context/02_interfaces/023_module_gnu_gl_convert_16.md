# Interface Facts: module_gnu_gl_convert_16
...
- Struct definitions observed: 136
...
- Definition location: [gnu/stat-w32.c:114-137]
- Source file: `gnu/stat-w32.c`
- Observed declaration: `struct timespec _gl_convert_FILETIME_to_timespec (const FILETIME *ft);`
- Approximate function body length: 24 lines
### `_gl_convert_FILETIME_to_POSIX`
- Definition location: [gnu/stat-w32.c:139-156]
- Source file: `gnu/stat-w32.c`
- Observed declaration: `time_t _gl_convert_FILETIME_to_POSIX (const FILETIME *ft);`
...
- `timespec`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

# Interface Facts: module_src_parseopt_file_07
...
## Functions
### `optfile_lookup`
- Definition location: [src/main.c:1141-1218]
- Source file: `src/main.c`
- Observed declaration: `static int optfile_lookup(char const *name, struct parseopt_file *pf);`
- Approximate function body length: 78 lines
### `parseopt_from_rc`
- Definition location: [src/main.c:1253-1283]
- Source file: `src/main.c`
- Observed declaration: `static int parseopt_from_rc(char const *file_name);`

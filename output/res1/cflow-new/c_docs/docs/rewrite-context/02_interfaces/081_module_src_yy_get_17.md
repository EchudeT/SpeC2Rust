# Interface Facts: module_src_yy_get_17
...
## Functions
### `yy_get_next_buffer`
- Definition location: [src/c.c:1741-1878]
- Source file: `src/c.c`
- Observed declaration: `static int yy_get_next_buffer (void) /* %endif */ /* %if-c++-only */ /* %endif */;`
- Approximate function body length: 138 lines
### `yy_get_previous_state`
- Definition location: [src/c.c:1884-1915]
- Source file: `src/c.c`
- Observed declaration: `static yy_state_type yy_get_previous_state (void) /* %endif */ /* %if-c++-only */ /* %endif */;`

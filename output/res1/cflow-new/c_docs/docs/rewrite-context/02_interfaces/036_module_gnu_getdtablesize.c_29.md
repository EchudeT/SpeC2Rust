# Interface Facts: module_gnu_getdtablesize.c_29
...
- Definition location: [gnu/getdtablesize.c:34-42]
- Source file: `gnu/getdtablesize.c`
- Observed declaration: `static int _setmaxstdio_nothrow (int newmax);`

# Interface Facts: module_gnu_if_11
...
## Functions
### `if`
- Definition location: [gnu/vasnprintf.c:3560-3628]
...
### `if`
- Definition location: [gnu/vasnprintf.c:5301-5551]
- Source file: `gnu/vasnprintf.c`
- Observed declaration: `else if (dp->conversion == 'g' || dp->conversion == 'G');`
- Approximate function body length: 251 lines

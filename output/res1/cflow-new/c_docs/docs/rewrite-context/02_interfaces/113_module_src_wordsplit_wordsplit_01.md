# Interface Facts: module_src_wordsplit_wordsplit_01
...
## Functions
### `is_name_char`
- Definition location: [src/wordsplit/wordsplit.c:55-62]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static inline int is_name_char (struct wordsplit *wsp, int c);`
- Approximate function body length: 8 lines
### `_wsplt_alloc_die`
- Definition location: [src/wordsplit/wordsplit.c:75-80]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void _wsplt_alloc_die (struct wordsplit *wsp);`
- Approximate function body length: 6 lines
### `_wsplt_seterr`
- Definition location: [src/wordsplit/wordsplit.c:98-107]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int _wsplt_seterr (struct wordsplit *wsp, int ec);`
- Approximate function body length: 10 lines
### `_wsplt_nomem`
- Definition location: [src/wordsplit/wordsplit.c:109-122]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int _wsplt_nomem (struct wordsplit *wsp);`
- Approximate function body length: 14 lines
### `_wsplt_store_errctx`
- Definition location: [src/wordsplit/wordsplit.c:124-139]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void _wsplt_store_errctx (struct wordsplit *wsp, char const *str, size_t len);`
- Approximate function body length: 16 lines
### `_wsplt_setctxerr`
- Definition location: [src/wordsplit/wordsplit.c:141-146]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static inline int _wsplt_setctxerr (struct wordsplit *wsp, int ec, char const *str, size_t len);`
- Approximate function body length: 6 lines
### `_wsplt_subsplit`
- Definition location: [src/wordsplit/wordsplit.c:157-211]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int _wsplt_subsplit (struct wordsplit *wsp, struct wordsplit *wss, char const *str, int len, int flags, int finalize);`
- Approximate function body length: 55 lines
### `_wsplt_seterr_sub`
- Definition location: [src/wordsplit/wordsplit.c:213-231]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void _wsplt_seterr_sub (struct wordsplit *wsp, struct wordsplit *wss);`
- Approximate function body length: 19 lines
### `wordsplit_init0`
- Definition location: [src/wordsplit/wordsplit.c:233-250]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void wordsplit_init0 (struct wordsplit *wsp);`
- Approximate function body length: 18 lines
### `wordsplit_init`
- Definition location: [src/wordsplit/wordsplit.c:263-369]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wordsplit_init (struct wordsplit *wsp, const char *input, size_t len, int flags);`
- Approximate function body length: 107 lines
### `alloc_space`
- Definition location: [src/wordsplit/wordsplit.c:371-400]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int alloc_space (struct wordsplit *wsp, size_t count);`
- Approximate function body length: 30 lines
### `wsnode_ptr`
- Definition location: [src/wordsplit/wordsplit.c:468-477]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static const char * wsnode_ptr (struct wordsplit *wsp, struct wordsplit_node *p);`
- Approximate function body length: 10 lines
### `wsnode_new`
- Definition location: [src/wordsplit/wordsplit.c:490-498]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static int wsnode_new (struct wordsplit *wsp, struct wordsplit_node **pnode);`
- Approximate function body length: 9 lines
### `wsnode_append`
- Definition location: [src/wordsplit/wordsplit.c:508-518]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void wsnode_append (struct wordsplit *wsp, struct wordsplit_node *node);`
- Approximate function body length: 11 lines
### `wsnode_remove`
- Definition location: [src/wordsplit/wordsplit.c:520-542]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void wsnode_remove (struct wordsplit *wsp, struct wordsplit_node *node);`

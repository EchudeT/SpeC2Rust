# Interface Facts: module_gnu_execute_all_15
...
- Definition location: [gnu/fd-hook.c:47-51]
- Source file: `gnu/fd-hook.c`
- Observed declaration: `int execute_all_close_hooks (gl_close_fn primary, int fd);`
- Approximate function body length: 5 lines
### `execute_all_ioctl_hooks`
- Definition location: [gnu/fd-hook.c:65-70]
- Source file: `gnu/fd-hook.c`
- Observed declaration: `int execute_all_ioctl_hooks (gl_ioctl_fn primary, int fd, int request, void *arg);`

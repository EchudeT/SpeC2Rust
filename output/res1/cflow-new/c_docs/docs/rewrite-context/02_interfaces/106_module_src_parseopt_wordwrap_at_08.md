# Interface Facts: module_src_parseopt_wordwrap_at_08
...
## Functions
### `wordwrap_at_bol`
- Definition location: [src/parseopt/wordwrap.c:208-212]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `int wordwrap_at_bol (WORDWRAP_FILE wf);`
- Approximate function body length: 5 lines
### `wordwrap_at_eol`
- Definition location: [src/parseopt/wordwrap.c:217-221]
- Source file: `src/parseopt/wordwrap.c`
- Observed declaration: `int wordwrap_at_eol (WORDWRAP_FILE wf);`
- Approximate function body length: 5 lines

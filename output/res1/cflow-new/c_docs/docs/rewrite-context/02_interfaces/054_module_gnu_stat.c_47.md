# Interface Facts: module_gnu_stat.c_47
...
## Functions
### `is_unc_root`
- Definition location: [gnu/stat.c:79-102]
- Source file: `gnu/stat.c`
- Observed declaration: `static BOOL is_unc_root (const char *rname);`

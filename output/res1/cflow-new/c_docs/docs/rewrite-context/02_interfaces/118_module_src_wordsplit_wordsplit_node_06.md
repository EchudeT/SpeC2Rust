# Interface Facts: module_src_wordsplit_wordsplit_node_06
...
## Functions
### `wsnode_len`
- Definition location: [src/wordsplit/wordsplit.c:479-488]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static size_t wsnode_len (struct wordsplit_node *p);`
- Approximate function body length: 10 lines
### `wsnode_free`
- Definition location: [src/wordsplit/wordsplit.c:500-506]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static void wsnode_free (struct wordsplit_node *p);`
- Approximate function body length: 7 lines
### `wsnode_tail`
- Definition location: [src/wordsplit/wordsplit.c:544-550]
- Source file: `src/wordsplit/wordsplit.c`
- Observed declaration: `static struct wordsplit_node * wsnode_tail (struct wordsplit_node *p);`
- Approximate function body length: 7 lines

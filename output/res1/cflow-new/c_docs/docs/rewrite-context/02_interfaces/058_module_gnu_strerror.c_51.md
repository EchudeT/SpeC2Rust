# Interface Facts: module_gnu_strerror.c_51
...
## Functions
### `strerror`
- Definition location: [gnu/strerror.c:36-72]
- Source file: `gnu/strerror.c`
- Observed declaration: `char * strerror (int n) #undef strerror;`

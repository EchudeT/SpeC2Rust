# Interface Facts: module_src_delete_level_12
...
## Functions
### `delete_level_autos`
- Definition location: [src/symbol.c:274-284]
- Source file: `src/symbol.c`
- Observed declaration: `int delete_level_autos(void *data, void *call_data);`
- Approximate function body length: 11 lines
### `delete_level_statics`
- Definition location: [src/symbol.c:286-296]
- Source file: `src/symbol.c`
- Observed declaration: `int delete_level_statics(void *data, void *call_data);`
- Approximate function body length: 11 lines

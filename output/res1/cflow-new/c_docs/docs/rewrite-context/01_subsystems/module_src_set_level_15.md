...
- Observed focus: organized around functions with the `set_level` prefix
- Module category: `module_cluster`
- Directory scope: `src`

## 2. Inputs and Outputs
- At this stage, do not speculate about runtime I/O; define interface boundaries by the observed function signatures and source files.
- File input boundary: src/main.c, src/output.c
- Function count: 2

## 3. Core Interface List
- `set_level_indent` [src/main.c:324-367]: `static void set_level_indent(const char *str);`
- `set_level_mark` [src/output.c:30-38]: `static void set_level_mark(int lev, int mark);`

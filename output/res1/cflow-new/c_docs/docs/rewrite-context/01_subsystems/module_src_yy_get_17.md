...
- Observed focus: organized around functions with the `yy_get` prefix
...
- `yy_get_next_buffer` [src/c.c:1741-1878]: `static int yy_get_next_buffer (void) /* %endif */ /* %if-c++-only */ /* %endif */;`
- `yy_get_previous_state` [src/c.c:1884-1915]: `static yy_state_type yy_get_previous_state (void) /* %endif */ /* %if-c++-only */ /* %endif */;`

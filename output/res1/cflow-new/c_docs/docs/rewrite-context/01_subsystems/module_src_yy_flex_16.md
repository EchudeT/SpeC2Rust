...
- Observed focus: organized around functions with the `yy_flex_str` prefix
...
- `yy_flex_strncpy` [src/c.c:2688-2694]: `static void yy_flex_strncpy (char* s1, const char * s2, int n );`
- `yy_flex_strlen` [src/c.c:2698-2705]: `static int yy_flex_strlen (const char * s );`

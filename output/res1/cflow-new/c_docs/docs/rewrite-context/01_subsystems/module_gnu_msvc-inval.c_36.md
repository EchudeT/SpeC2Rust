...
- Observed focus: organized around functions with the `gl_msvc_inval_ensure_handler` prefix
...
- `gl_msvc_inval_ensure_handler` [gnu/msvc-inval.c:121-129]: `void gl_msvc_inval_ensure_handler (void);`

...
- Observed focus: organized around functions with the `delete_level` prefix
...
- `delete_level_autos` [src/symbol.c:274-284]: `int delete_level_autos(void *data, void *call_data);`
- `delete_level_statics` [src/symbol.c:286-296]: `int delete_level_statics(void *data, void *call_data);`

...
- Observed focus: organized around functions with the `print_and_abort` prefix
...
- `print_and_abort` [gnu/obstack.c:310-324]: `static __attribute_noreturn__ void print_and_abort (void);`

...
- `yy_create_buffer` [src/c.c:2169-2194]: `YY_BUFFER_STATE yy_create_buffer (FILE * file, int size ) /* %endif */ /* %if-c++-only */ /* %endif */;`
- `yyensure_buffer_stack` [src/c.c:2363-2407]: `static void yyensure_buffer_stack (void) /* %endif */ /* %if-c++-only */ /* %endif */;`
- `yy_scan_buffer` [src/c.c:2417-2444]: `YY_BUFFER_STATE yy_scan_buffer (char * base, yy_size_t size );`

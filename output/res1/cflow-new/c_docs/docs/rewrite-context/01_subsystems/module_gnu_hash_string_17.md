...
- Observed focus: organized around functions with the `hash_string` prefix
...
- `hash_string` [gnu/hash.c:359-373]: `size_t hash_string (const char *string, size_t n_buckets);`
- `hash_string` [gnu/hash.c:382-391]: `size_t hash_string (const char *string, size_t n_buckets);`

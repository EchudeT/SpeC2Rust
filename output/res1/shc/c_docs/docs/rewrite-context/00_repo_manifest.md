...
- Entry files: none
- Executables observed at the repository root: .gitattributes, .gitignore, .travis.yml, aclocal.m4, AUTHORS, autogen.sh, ChangeLog, config.log, config.status, configure, configure.ac, COPYING, INSTALL, Makefile, Makefile.am, Makefile.in, man.html, man.md, NEWS, README.md, shc, shc.1
...
- `root`: 22 files total (0 C files, 0 header files, 22 other files). Examples: .gitattributes, .gitignore, .travis.yml, AUTHORS, COPYING, ChangeLog
- `src`: 5 files total (1 C files, 0 header files, 4 other files). Examples: src/Makefile, src/Makefile.am, src/Makefile.in, src/shc.c, src/shc.o

# Interface Facts: main_root_full-write.c_27
...
- Directory: `root`
- File list: full-write.c
- Candidate header files: include/config.h, include/full-write.h
...
## Functions
### `full_rw`
- Definition location: [full-write.c:57-79]
- Source file: `full-write.c`
- Observed declaration: `size_t full_rw (int fd, const void *buf, size_t count);`

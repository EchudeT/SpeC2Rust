# Interface Facts: main_root_propername-lite.c_31
...
- Directory: `root`
- File list: propername-lite.c
- Candidate header files: include/c-strcase.h, include/config.h, include/gettext.h, include/localcharset.h, include/propername.h
...
## Functions
### `proper_name_lite`
- Definition location: [propername-lite.c:29-36]
- Source file: `propername-lite.c`
- Observed declaration: `char const * proper_name_lite (char const *name_ascii, char const *name_utf8);`

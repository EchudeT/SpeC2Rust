# Interface Facts: main_root_copy-file-range.c_21
...
- Directory: `root`
- File list: copy-file-range.c
- Candidate header files: include/config.h, include/unistd.h
- Exported functions observed: 1
- Struct definitions observed: 1
...
## Functions
### `copy_file_range`
- Definition location: [copy-file-range.c:27-67]
- Source file: `copy-file-range.c`
- Observed declaration: `ssize_t copy_file_range (int infd, off_t *pinoff, int outfd, off_t *poutoff, size_t length, unsigned int flags);`
- Approximate function body length: 41 lines

## Structs and Types
### `anonymous`
- Definition location: [copy-file-range.c:50]
- Source file: `copy-file-range.c`
- Observed declaration prefix: `struct utsname`

## Referenced External Types
- `utsname`: this name came from clustering metadata or nearby call analysis, but no local definition was observed in the current module files.

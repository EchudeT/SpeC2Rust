# Interface Facts: main_root_version_etc_05
...
- Directory: `root`
- File list: version-etc.c
- Candidate header files: include/config.h, include/gettext.h, include/stdio.h, include/version-etc.h
...
## Functions
### `version_etc_arn`
- Definition location: [version-etc.c:60-176]
- Source file: `version-etc.c`
- Observed declaration: `void version_etc_arn (FILE *stream, const char *command_name, const char *package, const char *version, const char * const * authors, size_t n_authors);`
- Approximate function body length: 117 lines
### `version_etc_ar`
- Definition location: [version-etc.c:182-192]
- Source file: `version-etc.c`
- Observed declaration: `void version_etc_ar (FILE *stream, const char *command_name, const char *package, const char *version, const char * const * authors);`
- Approximate function body length: 11 lines
### `version_etc_va`
- Definition location: [version-etc.c:198-213]
- Source file: `version-etc.c`
- Observed declaration: `void version_etc_va (FILE *stream, const char *command_name, const char *package, const char *version, va_list authors);`
- Approximate function body length: 16 lines
### `version_etc`
- Definition location: [version-etc.c:229-239]
- Source file: `version-etc.c`
- Observed declaration: `void version_etc (FILE *stream, const char *command_name, const char *package, const char *version, /* const char *author1, ...*/ ...);`
- Approximate function body length: 11 lines

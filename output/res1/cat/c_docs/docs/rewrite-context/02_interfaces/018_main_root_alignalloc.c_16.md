# Interface Facts: main_root_alignalloc.c_16
...
- Directory: `root`
- File list: alignalloc.c
- Candidate header files: include/alignalloc.h, include/config.h, include/limits.h, include/stdckdint.h
...
## Functions
### `align_down`
- Definition location: [alignalloc.c:44-49]
- Source file: `alignalloc.c`
- Observed declaration: `static void * align_down (void *p, idx_t alignment);`
- Approximate function body length: 6 lines
### `address_of_pointer_to_malloced`
- Definition location: [alignalloc.c:55-66]
- Source file: `alignalloc.c`
- Observed declaration: `static void ** address_of_pointer_to_malloced (unsigned char *r);`
- Approximate function body length: 12 lines
### `alignalloc`
- Definition location: [alignalloc.c:74-102]
- Source file: `alignalloc.c`
- Observed declaration: `void * alignalloc (idx_t alignment, idx_t size);`
- Approximate function body length: 29 lines
### `alignfree`
- Definition location: [alignalloc.c:106-116]
- Source file: `alignalloc.c`
- Observed declaration: `void alignfree (void *ptr);`
...
- `ALIGNALLOC_INLINE` [alignalloc.c:22]: `#define ALIGNALLOC_INLINE _GL_EXTERN_INLINE`

# Interface Facts: main_root_progname.c_30
...
- Directory: `root`
- File list: progname.c
- Candidate header files: include/config.h, include/progname.h, include/stdio.h, include/stdlib.h, include/string.h
...
## Functions
### `set_program_name`
- Definition location: [progname.c:38-92]
- Source file: `progname.c`
- Observed declaration: `void set_program_name (const char *argv0);`
